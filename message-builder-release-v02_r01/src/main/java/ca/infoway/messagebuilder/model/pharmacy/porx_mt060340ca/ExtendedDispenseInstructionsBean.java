...
/**
 * <p>Extended Dispense Instructions</p>
 * 
 ...
 */
@Hl7PartTypeMapping({"PORX_MT060340CA.SupplyRequestItem"})
public class ExtendedDispenseInstructionsBean extends MessagePartBean {
    ...
    @Hl7XmlMapping({"component1/subsequentSupplyRequest/effectiveTime"})
    ...
    @Hl7XmlMapping({"component1/subsequentSupplyRequest/repeatNumber"})
    ...
    @Hl7XmlMapping({"component1/subsequentSupplyRequest/quantity"})
    ...
    @Hl7XmlMapping({"component1/subsequentSupplyRequest/expectedUseTime"})
