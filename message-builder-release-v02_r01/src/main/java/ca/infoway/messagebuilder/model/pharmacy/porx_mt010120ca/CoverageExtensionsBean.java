 ...
 * providers.</p>
 */
@Hl7PartTypeMapping({"PORX_MT010120CA.Coverage"})
public class CoverageExtensionsBean extends MessagePartBean {
    ...
    @Hl7XmlMapping({"author/underwriter/underwritingOrganization/id"})
    ...
    @Hl7XmlMapping({"author/underwriter/underwritingOrganization/name"})
    ...
    @Hl7XmlMapping({"author/underwriter/underwritingOrganization/assignedOrganization/code"})
    ...
    @Hl7XmlMapping({"author/underwriter/underwritingOrganization/assignedOrganization/telecom"})
