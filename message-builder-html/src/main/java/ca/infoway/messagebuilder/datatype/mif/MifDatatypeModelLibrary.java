...
@Root(name="datatypeModelLibrary",strict=false)
public class MifDatatypeModelLibrary {
	...
	public void setPackageLocation(MifIdentifier packageLocation) {
	...
	public void setHeader(MifHeader header) {
		this.header = header;
	}
	...
	public List<MifDatatype> getDatatypes() {
		return datatypes;
	}
