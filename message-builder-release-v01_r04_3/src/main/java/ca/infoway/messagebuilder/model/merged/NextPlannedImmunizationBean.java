...
public class NextPlannedImmunizationBean extends MessagePartBean {
    ...
    private IVL<TS, Interval<Date>> renewalDate = new IVLImpl<TS, Interval<Date>>();

    @Hl7XmlMapping({"effectiveTime"})
    public Interval<Date> getRenewalDate() {
        return this.renewalDate.getValue();
    }
    public void setRenewalDate(Interval<Date> renewalDate) {
