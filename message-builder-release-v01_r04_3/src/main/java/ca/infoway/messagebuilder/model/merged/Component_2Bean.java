...
public class Component_2Bean extends MessagePartBean {
    ...
    private ResponsiblePersonBean supplyEventReceiverResponsibleParty;
    ...
    @Hl7XmlMapping({"supplyEvent/receiver/responsibleParty"})
    public ResponsiblePersonBean getSupplyEventReceiverResponsibleParty() {
        return this.supplyEventReceiverResponsibleParty;
    }
    public void setSupplyEventReceiverResponsibleParty(ResponsiblePersonBean supplyEventReceiverResponsibleParty) {
        this.supplyEventReceiverResponsibleParty = supplyEventReceiverResponsibleParty;
    }
