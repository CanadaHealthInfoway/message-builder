...
public class MifValueSetRelatedCode {

	@Attribute(required=false)
	private String relationshipTraversal;

	public String getRelationshipTraversal() {
		return relationshipTraversal;
	}

	public void setRelationshipTraversal(String relationshipTraversal) {
		this.relationshipTraversal = relationshipTraversal;
	}
	
	public boolean isRecursive() {
		return ("TransitiveClosure".equals(relationshipTraversal));
	}
