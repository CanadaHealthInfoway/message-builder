...
@Root(name="TemplateExport",strict=false)
@Namespace(reference="http://www.lantanagroup.com")
public class TemplateExport {
	
	@ElementList(required=false,inline=true,entry="Template")
	private List<CdaTemplate> templates = new ArrayList<CdaTemplate>();
