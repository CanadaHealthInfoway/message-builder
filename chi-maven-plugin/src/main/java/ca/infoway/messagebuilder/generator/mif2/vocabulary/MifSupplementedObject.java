...
public class MifSupplementedObject {

	@Attribute
	private String name;
	
	@ElementList(entry="param", inline=true, required=false)
	private List<MifHttpParam> params = new ArrayList<MifHttpParam>();
	...
	public List<MifHttpParam> getParams() {
		return params;
	}

	public void setParams(List<MifHttpParam> params) {
		this.params = params;
	}
	
	public String getParam(String name) {
		for (MifHttpParam param : this.params) {
