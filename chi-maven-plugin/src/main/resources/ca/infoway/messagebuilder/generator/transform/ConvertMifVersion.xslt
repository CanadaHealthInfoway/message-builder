...
<!--  <xsl:include href="./ConvertMif213toFrom214.xslt"/>-->
...
<!--  <xsl:include href="./ConvertMif214toFrom215.xslt"/>-->
...
<!--  <xsl:include href="./ConvertMif215toFrom216.xslt"/>-->
...
<!-- actual xsl code begins -->
  
  <xsl:param name="fromVersion" select="/*/@schemaVersion"/>
  <xsl:param name="toVersion" select="'2.1.3'"/>
  <xsl:template match="/">
      <xsl:choose>
        <xsl:when test="$fromVersion='2.1.6'">
          <xsl:apply-templates mode="Do2.1.6to2.1.5">
            <xsl:with-param name="toVersion" select="$toVersion"/>
          </xsl:apply-templates>
        </xsl:when>
        <xsl:when test="$fromVersion='2.1.5'">
          <xsl:apply-templates mode="Do2.1.5to2.1.4">
            <xsl:with-param name="toVersion" select="$toVersion"/>
          </xsl:apply-templates>
        </xsl:when>
        <xsl:when test="$fromVersion='2.1.4'">
          <xsl:apply-templates mode="Do2.1.4to2.1.3">
            <xsl:with-param name="toVersion" select="$toVersion"/>
          </xsl:apply-templates>
        </xsl:when>
      </xsl:choose>
