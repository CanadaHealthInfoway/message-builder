...
import ca.infoway.messagebuilder.model.ccda_pcs_r1_1.domainvalue.MedicationFillStatus;
...
public class SupplyBean extends MessagePartBean {
    ...
    private SXCMTSCDAR1 effectiveTime = new SXCMTSCDAR1Impl();
    ...
    public MedicationFillStatus getStatusCode() {
        return (MedicationFillStatus) this.statusCode.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setStatusCode(MedicationFillStatus statusCode) {
