...
public class ProcedureNoteBean extends MessagePartBean {
     ...
     */
    @Hl7XmlMapping({"code"})
    public ProcedureNoteDocumentTypeCode getCode() {
        return (ProcedureNoteDocumentTypeCode) this.code.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setCode(ProcedureNoteDocumentTypeCode code) {
