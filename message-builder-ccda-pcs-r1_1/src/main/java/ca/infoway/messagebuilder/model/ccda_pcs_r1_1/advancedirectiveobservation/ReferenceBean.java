...
public class ReferenceBean extends MessagePartBean implements ReferenceChoice {
    ...
    private LIST<CS, Code> externalDocumentRealmCode = new LISTImpl<CS, Code>(CSImpl.class);
    ...
    public List<Code> getExternalDocumentRealmCode() {
        return this.externalDocumentRealmCode.rawList(Code.class);
    }
