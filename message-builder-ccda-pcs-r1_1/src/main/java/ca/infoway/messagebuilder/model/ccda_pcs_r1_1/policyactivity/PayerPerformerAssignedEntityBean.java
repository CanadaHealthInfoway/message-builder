...
public class PayerPerformerAssignedEntityBean extends MessagePartBean {
     ...
     */
    @Hl7XmlMapping({"code"})
    public FinanciallyResponsiblePartyType getCode() {
        return (FinanciallyResponsiblePartyType) this.code.getValue();
    }
     ...
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    public void setCode(FinanciallyResponsiblePartyType code) {
