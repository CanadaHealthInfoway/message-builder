...
import ca.infoway.messagebuilder.model.ccda_pcs_r1_1.domainvalue.DIRDocumentTypeCodes;
...
public class ClinicalDocumentBean extends MessagePartBean {
    ...
    private List<RelatedDocumentChoice> relatedDocument = new ArrayList<RelatedDocumentChoice>();
     ...
     */
    @Hl7XmlMapping({"code"})
    public DIRDocumentTypeCodes getCode() {
        return (DIRDocumentTypeCodes) this.code.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setCode(DIRDocumentTypeCodes code) {
    ...
    public List<RelatedDocumentChoice> getRelatedDocument() {
