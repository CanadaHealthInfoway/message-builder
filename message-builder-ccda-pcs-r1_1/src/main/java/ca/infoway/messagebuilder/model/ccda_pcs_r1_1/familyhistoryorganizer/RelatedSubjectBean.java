...
import ca.infoway.messagebuilder.model.ccda_pcs_r1_1.domainvalue.FamilyMember;
...
public class RelatedSubjectBean extends MessagePartBean {
    ...
    private CE subjectAdministrativeGenderCode = new CEImpl();
    private TSCDAR1 subjectBirthTime = new TSCDAR1Impl();
    private BL subjectDeceasedInd = new BLImpl();
    private TSCDAR1 subjectDeceasedTime = new TSCDAR1Impl();
    ...
    public FamilyMember getCode() {
        return (FamilyMember) this.code.getValue();
    }
    ...
    public AdministrativeGender getSubjectAdministrativeGenderCode() {
        return (AdministrativeGender) this.subjectAdministrativeGenderCode.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setSubjectAdministrativeGenderCode(AdministrativeGender subjectAdministrativeGenderCode) {
