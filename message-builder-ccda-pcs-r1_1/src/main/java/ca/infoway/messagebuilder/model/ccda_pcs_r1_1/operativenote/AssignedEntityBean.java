...
import ca.infoway.messagebuilder.model.ccda_pcs_r1_1.domainvalue.ProviderRole;
...
public class AssignedEntityBean extends MessagePartBean {
     ...
     */
    @Hl7XmlMapping({"code"})
    public ProviderRole getCode() {
        return (ProviderRole) this.code.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setCode(ProviderRole code) {
