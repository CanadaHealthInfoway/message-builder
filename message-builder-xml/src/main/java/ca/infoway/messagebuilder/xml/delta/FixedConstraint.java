...
@Table(name="fixed_change")
public class FixedConstraint extends NewStringValueConstraint {

	private static final long serialVersionUID = -2918484570998343081L;

	public FixedConstraint() {
	}
	public FixedConstraint(String originalValue, String newValue) {
