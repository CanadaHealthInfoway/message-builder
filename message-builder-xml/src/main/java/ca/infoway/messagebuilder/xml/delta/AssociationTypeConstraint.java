...
public class AssociationTypeConstraint extends NewStringValueConstraint {

	private static final long serialVersionUID = -5578004765191579096L;

	public AssociationTypeConstraint() {
	}
	public AssociationTypeConstraint(String originalValue, String newValue) {
	...
	public ConstraintChangeType getChange() {
		return ConstraintChangeType.CHANGE_ASSOCIATION_TYPE;
	}
