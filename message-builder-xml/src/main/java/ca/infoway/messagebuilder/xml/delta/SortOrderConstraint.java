...
@Table(name="sort_order_change")
public class SortOrderConstraint extends NewIntegerValueConstraint {

	private static final long serialVersionUID = -8765558778534699583L;

	public SortOrderConstraint() {
	}
	public SortOrderConstraint(Integer originalValue, Integer newValue) {
