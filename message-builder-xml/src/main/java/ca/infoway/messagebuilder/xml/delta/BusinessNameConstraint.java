...
@Table(name="business_name_change")
public class BusinessNameConstraint extends NewStringValueConstraint {

	private static final long serialVersionUID = -5968091278823057036L;
	
	public BusinessNameConstraint() {
	}
	public BusinessNameConstraint(String originalValue, String newValue) {
