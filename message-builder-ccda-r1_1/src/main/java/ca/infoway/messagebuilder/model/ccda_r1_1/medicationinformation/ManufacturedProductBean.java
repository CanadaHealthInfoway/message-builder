...
package ca.infoway.messagebuilder.model.ccda_r1_1.medicationinformation;
...
import ca.infoway.messagebuilder.model.ccda_r1_1.domainvalue.MedicationClinicalDrugName;
...
public class ManufacturedProductBean extends MessagePartBean {
    ...
    private LIST<CS_R2<Code>, CodedTypeR2<Code>> manufacturedMaterialRealmCode = new LISTImpl<CS_R2<Code>, CodedTypeR2<Code>>(CS_R2Impl.class);
    ...
    private CE_R2<MedicationClinicalDrugName> manufacturedMaterialCode = new CE_R2Impl<MedicationClinicalDrugName>();
    ...
    public CodedTypeR2<MedicationClinicalDrugName> getManufacturedMaterialCode() {
        return (CodedTypeR2<MedicationClinicalDrugName>) this.manufacturedMaterialCode.getValue();
    }
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     */
    public void setManufacturedMaterialCode(CodedTypeR2<MedicationClinicalDrugName> manufacturedMaterialCode) {
