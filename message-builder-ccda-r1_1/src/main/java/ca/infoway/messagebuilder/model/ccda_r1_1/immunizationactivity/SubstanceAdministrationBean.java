...
import ca.infoway.messagebuilder.model.ccda_r1_1.merged.Participant2Bean;
...
public class SubstanceAdministrationBean extends MessagePartBean {
    ...
    private CE_R2<MedicationRoute> routeCode = new CE_R2Impl<MedicationRoute>();
    private CD_R2<BodySite> approachSiteCode = new CD_R2Impl<BodySite>();
    ...
    private CE_R2<MedicationProductForm> administrationUnitCode = new CE_R2Impl<MedicationProductForm>();
