...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_9;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_9> entry = new ArrayList<EntryChoice_9>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_9> getEntry() {
        return this.entry;
    }
