...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_7;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_7> entry = new ArrayList<EntryChoice_7>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_7> getEntry() {
        return this.entry;
    }
