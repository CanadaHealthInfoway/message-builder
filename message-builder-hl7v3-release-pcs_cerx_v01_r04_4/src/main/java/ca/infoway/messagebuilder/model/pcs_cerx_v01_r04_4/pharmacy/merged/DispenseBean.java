...
public class DispenseBean extends MessagePartBean implements ca.infoway.messagebuilder.model.pcs_cerx_v01_r04_4.pharmacy.porx_mt980010ca.CausalActs, ca.infoway.messagebuilder.model.pcs_cerx_v01_r04_4.pharmacy.porx_mt980020ca.CausalActs {
    ...
    private II inFulfillmentOfSubstanceAdministrationEventId = new IIImpl();
     ...
     * 
     * <p>Relationship: 
     * PORX_MT980020CA.SubstanceAdministrationEvent.id</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     * <p>When specifying an issue between multiple prescriptions 
     * and dispenses - say for example a Duplicate Drug issue where 
     * you have subject elements for Prescription A, a Dispense for 
     * Prescript ion A, Prescription B and a Dispense for 
     * Prescription B, it can be confusing for the pharmacists 
     * because they see the two Dispenses (supplyEvent class), but 
     * there is nothing to link them to their parent 
     * prescriptions.</p>
     * 
     * <p>A Prescription Order Number linked to a specific Issue 
     * Detected.</p>
     */
    @Hl7XmlMapping({"inFulfillmentOf/substanceAdministrationEvent/id"})
    public Identifier getInFulfillmentOfSubstanceAdministrationEventId() {
        return this.inFulfillmentOfSubstanceAdministrationEventId.getValue();
    }
     ...
     * Detected.</p>
     */
    public void setInFulfillmentOfSubstanceAdministrationEventId(Identifier inFulfillmentOfSubstanceAdministrationEventId) {
        this.inFulfillmentOfSubstanceAdministrationEventId.setValue(inFulfillmentOfSubstanceAdministrationEventId);
    }
