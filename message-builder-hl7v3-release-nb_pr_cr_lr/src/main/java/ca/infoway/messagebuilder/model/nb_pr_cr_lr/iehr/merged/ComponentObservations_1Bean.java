...
import ca.infoway.messagebuilder.model.nb_pr_cr_lr.domainvalue.SimpleMeasurableClinicalObservationSubType;
...
public class ComponentObservations_1Bean extends MessagePartBean {
     ...
     */
    @Hl7XmlMapping({"code"})
    public SimpleMeasurableClinicalObservationSubType getCode() {
        return (SimpleMeasurableClinicalObservationSubType) this.code.getValue();
    }
     ...
     * made.</p><p>E.g. systolic blood pressure.</p>
     */
    public void setCode(SimpleMeasurableClinicalObservationSubType code) {
