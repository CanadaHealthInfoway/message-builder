...
package ca.infoway.messagebuilder.model.nb_pr_cr_lr.cr.prpa_mt101104nb;
...
import ca.infoway.messagebuilder.model.nb_pr_cr_lr.cr.merged.ConfidenceValueBean;
 ...
 */
@Hl7PartTypeMapping({"PRPA_MT101104NB.IdentifiedEntity"})
@Hl7RootType
public class IdentifiedPersonBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.IdentifiedEntity.id</p>
     * 
     ...
     * facility.</p>
     * 
     * <p><ul> <li><span style="font-family: Arial; ">For each 
     * candidate patient record received by the local POS from the 
     * CR, the Provincial Drug Identifier will be included if it 
     * exists in the CR. This value is not to be displayed to the 
     * User.</span></li> <li><span style="font-family: Arial; 
     * ">This Provincial Drug Identifier will be in the 
     * &ldquo;id&rdquo; field in the &ldquo;/subject/ 
     * registrationEvent/ subject/ identifiedEntity/&rdquo; message 
     * path. Note that although the HL7 standard indicates that the 
     * &ldquo;displayable&rdquo; property is &ldquo;true&rdquo;, in 
     * this case, it will be &ldquo;false&rdquo; since it shall not 
     * be displayed.<br type="_moz" /> </span></li> <li><span 
     * style="font-family: Arial; ">In certain situations it is 
     * possible that a patient in the CR does not have a Provincial 
     * Drug Identifier. Since the &ldquo;id&rdquo; element in the 
     * message path &ldquo;/subject /registrationEvent /subject/ 
     * identifiedEntity&rdquo; is HL7 populated, it will be 
     * included and set to nullFlavor. See the &ldquo;Add Person 
     * Request&rdquo; message in the event that the patient needs a 
     * Provincial Drug Identifier created.</span></li> </ul></p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.IdentifiedEntity.statusCode</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * PRPA_MT101104NB.IdentifiedEntity.effectiveTime</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * PRPA_MT101104NB.IdentifiedEntity.confidentialityCode</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.name</p>
     * 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.telecom</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * PRPA_MT101104NB.Person.administrativeGenderCode</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     * <p>Populated attribute supports the identification of the 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.birthTime</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     * <p>Populated attribute supports the identification of the 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.deceasedInd</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (0-1)</p>
     * 
     * <p>Required attribute supports the identification of the 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.deceasedTime</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.multipleBirthInd</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (0-1)</p>
     * 
     * <p>Required attribute supports the identification of the 
     ...
     * 
     * <p>Relationship: 
     * PRPA_MT101104NB.Person.multipleBirthOrderNumber</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (0-1)</p>
     * 
     * <p>Required attribute supports the identification of the 
     ...
     * 
     * <p>Relationship: PRPA_MT101104NB.Person.addr</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1-10)</p>
     * 
     * <p>Populated attribute supports the identification of the 
    ...
    /**
     * <p>Relationship: PRPA_MT101104NB.Person.asOtherIDs</p>
     * 
    ...
    /**
     * <p>Relationship: PRPA_MT101104NB.Person.personalRelationship</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * PRPA_MT101104NB.Person.languageCommunication</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1-10)</p>
     */
    ...
    /**
     * <p>Relationship: PRPA_MT101104NB.Subject.observationEvent</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     */
