 ...
 */
@Hl7PartTypeMapping({"PRPM_MT306011NB.Organization"})
public class OrganizationBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PRPM_MT306011NB.Organization.id</p>
     * 
     ...
     * 
     * <p>This provides the licensing society for the provider. The 
     * &ldquo;id&rdquo; will contain the root (the licensing 
     * society) and a usage (always use=&ldquo;BUS&rdquo;); no 
     * extension will be present.</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * 
     * <p>Relationship: PRPM_MT306011NB.Organization.name</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (0-1)</p>
     * 
     * <p>Required attribute supports the validation and 
     ...
     * 
     * <p>Relationship: PRPM_MT306011NB.Organization.addr</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * PRPM_MT306011NB.Organization.territorialAuthority</p>
     * 
