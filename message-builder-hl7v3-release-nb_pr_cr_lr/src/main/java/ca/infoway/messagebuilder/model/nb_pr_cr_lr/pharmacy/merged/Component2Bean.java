...
import ca.infoway.messagebuilder.model.nb_pr_cr_lr.domainvalue.COMP;
...
public class Component2Bean extends MessagePartBean {
    ...
    public COMP getTypeCode() {
        return (COMP) this.typeCode.getValue();
    }
     ...
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    public void setTypeCode(COMP typeCode) {
