 ...
 */
@Hl7PartTypeMapping({"POLB_MT004000NB.InterpretationRange"})
public class ReferenceRangeBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: POLB_MT004000NB.InterpretationRange.value</p>
     * 
     ...
     * values (Lo - Hi) of the same datatype as the observation to 
     * which they apply (carried as an IVL). In some cases there 
     * may only be a single value (not a range or interval).</p>
     */
    @Hl7XmlMapping({"value"})
     ...
     * 
     * <p>Relationship: 
     * POLB_MT004000NB.InterpretationRange.interpretationCode</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * POLB_MT004000NB.Precondition.observationEventCriterion</p>
     * 
