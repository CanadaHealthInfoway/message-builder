...
public class IdentifiedPersonBean extends MessagePartBean {
     ...
     * facility.</p>
     * 
     * <ul> <li><span style="font-family: Arial; ">For each 
     ...
     * be displayed. </span></li> <li><span style="font-family: 
     * Arial; ">In certain situations it is possible that a patient 
     * in the CR does not have a Provincial Drug Identifier. Since 
     * the &ldquo;id&rdquo; element in the message path 
     * &ldquo;/subject /registrationEvent /subject/ 
     ...
     * Provincial Drug Identifier created.</span></li> </ul>
     */
    @Hl7XmlMapping({"id"})
