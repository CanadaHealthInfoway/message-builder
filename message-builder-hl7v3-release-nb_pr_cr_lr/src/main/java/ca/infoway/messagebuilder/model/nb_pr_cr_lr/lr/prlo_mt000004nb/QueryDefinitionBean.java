...
package ca.infoway.messagebuilder.model.nb_pr_cr_lr.lr.prlo_mt000004nb;
...
public class QueryDefinitionBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PRLO_MT000004NB.RecordId.value</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     ...
     * 
     * <p>A valid New Brunswick Location record identifier must be 
     * specified.</p>
     */
    @Hl7XmlMapping({"recordId/value"})
    public Identifier getRecordIdValue() {
        return this.recordIdValue.getValue();
    }
     ...
     * specified.</p>
     */
    public void setRecordIdValue(Identifier recordIdValue) {
        this.recordIdValue.setValue(recordIdValue);
    }
