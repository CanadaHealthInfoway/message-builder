...
package ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt120600nb;
 ...
 * (e.g. phone).</p>
 */
@Hl7PartTypeMapping({"COCT_MT120600NB.Annotation"})
@Hl7RootType
public class NotesBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: COCT_MT120600NB.Annotation.text</p>
     * 
     ...
     * 
     * <p>Relationship: COCT_MT120600NB.Author.time</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
    ...
    public ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090102nb.HealthcareWorkerBean getAuthorAssignedPersonAsAssignedEntity1() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090102nb.HealthcareWorkerBean ? (ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090102nb.HealthcareWorkerBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsAssignedEntity1() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090102nb.HealthcareWorkerBean);
    }
    ...
    public ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910102nb.RelatedPersonBean getAuthorAssignedPersonAsPersonalRelationship1() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910102nb.RelatedPersonBean ? (ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910102nb.RelatedPersonBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsPersonalRelationship1() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910102nb.RelatedPersonBean);
    }

    public ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt911102nb.ActingPerson getAuthorAssignedPersonAsActingPerson1() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt911102nb.ActingPerson ? (ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt911102nb.ActingPerson) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsActingPerson1() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt911102nb.ActingPerson);
    }
    ...
    public ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090508nb.HealthcareOrganizationBean getAuthorAssignedPersonAsAssignedEntity4() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090508nb.HealthcareOrganizationBean ? (ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090508nb.HealthcareOrganizationBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsAssignedEntity4() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt090508nb.HealthcareOrganizationBean);
    }
    ...
    public ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910107nb.RelatedPersonBean getAuthorAssignedPersonAsPersonalRelationship4() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910107nb.RelatedPersonBean ? (ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910107nb.RelatedPersonBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsPersonalRelationship4() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.nb_pr_cr_lr.common.coct_mt910107nb.RelatedPersonBean);
    }
