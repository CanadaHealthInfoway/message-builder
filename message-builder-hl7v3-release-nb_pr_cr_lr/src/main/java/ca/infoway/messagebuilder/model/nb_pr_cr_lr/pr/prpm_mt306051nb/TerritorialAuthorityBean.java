...
package ca.infoway.messagebuilder.model.nb_pr_cr_lr.pr.prpm_mt306051nb;
...
import ca.infoway.messagebuilder.model.nb_pr_cr_lr.domainvalue.PART;
import ca.infoway.messagebuilder.model.nb_pr_cr_lr.domainvalue.TerritorialAuthorityRoleType;
 ...
 */
@Hl7PartTypeMapping({"PRPM_MT306051NB.TerritorialAuthority"})
public class TerritorialAuthorityBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PRPM_MT306051NB.TerritorialAuthority.code</p>
     * 
     ...
     * 
     * <p>Relationship: PRPM_MT306051NB.Jurisdiction.code</p>
     * 
    ...
    /**
     * <p>Relationship: PRPM_MT306051NB.Part.typeCode</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"part/typeCode"})
    public PART getPartTypeCode() {
        return (PART) this.partTypeCode.getValue();
    }
     ...
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    public void setPartTypeCode(PART partTypeCode) {
        this.partTypeCode.setValue(partTypeCode);
    }


    /**
     * <p>Relationship: PRPM_MT306051NB.Part.territorialAuthority</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     */
