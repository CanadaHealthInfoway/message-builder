...
public class AnyElementParserTest extends CeRxDomainValueTestCase {
	...
	public void testParseAnyWithSpecializationTypeInOuterElement() throws Exception {
		...
		UncertainRange<PhysicalQuantity> range = 
			(UncertainRange<PhysicalQuantity>)new AnyElementParser().parse(
				ParseContextImpl.create("ANY.LAB", Object.class, SpecificationVersion.R02_04_02, null, null, ConformanceLevel.MANDATORY, null, null, false), 
	...
	public void testParseRetainsProperDatatype() throws Exception {
		...
		BareANY result = new AnyElementParser().parse(
				ParseContextImpl.create("ANY.LAB", Object.class, SpecificationVersion.V02R02, null, null, ConformanceLevel.MANDATORY, null, null, false), 
				node, this.xmlResult);
	...
	public void testParsePQForAnyX1() throws Exception {
		...
		BareANY result = new AnyElementParser().parse(
				ParseContextImpl.create("ANY.x1", Object.class, SpecificationVersion.V02R02, null, null, ConformanceLevel.MANDATORY, null, null, false), 
				node, this.xmlResult);
	...
	public void testParsePQForAnyX2ShouldHaveError() throws Exception {
		...
		BareANY result = new AnyElementParser().parse(
				ParseContextImpl.create("ANY.x2", Object.class, SpecificationVersion.V02R02, null, null, ConformanceLevel.MANDATORY, null, null, false), 
				node, this.xmlResult);
	...
	public void testParseCdWithNullFlavorAndMetaData() throws Exception {
		...
		BareANY cdAny = new AnyElementParser().parse(
				ParseContextImpl.create("ANY", Object.class, SpecificationVersion.V02R02, null, null, ConformanceLevel.POPULATED, null, null, false), 
				node, this.xmlResult);
