...
public class CsR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        CS_R2<MockCharacters> cs = (CS_R2<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("CS", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        CS_R2<MockCharacters> cs = (CS_R2<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("CS", MockCharacters.class, V02R02, null, null, MANDATORY, null, null, false), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParseContextImpl.create("CS", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), node, this.xmlResult);
