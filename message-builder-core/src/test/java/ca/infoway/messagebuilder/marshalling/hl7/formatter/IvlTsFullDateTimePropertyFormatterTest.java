...
public class IvlTsFullDateTimePropertyFormatterTest extends FormatterTestCase {
	...
	public void testBasicAbstract() throws Exception {
		...
		String result = new IvlTsPropertyFormatter().format(new FormatContextImpl(this.result, null, "name", "IVL<TS.FULLDATEWITHTIME>", ConformanceLevel.POPULATED, null, false, SpecificationVersion.V02R02, timeZone, timeZone, null, false), 
				hl7DataType);
    ...
    protected FormatContext getContext(String name) {
    	return new FormatContextImpl(new ModelToXmlResult(), null, name, "IVL<TS.FULLDATETIME>", null, null, false);
    }
}
