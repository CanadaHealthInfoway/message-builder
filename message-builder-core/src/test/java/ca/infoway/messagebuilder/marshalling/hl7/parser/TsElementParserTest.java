...
public class TsElementParserTest extends MarshallingTestCase { 
    ...
    public void testParseValidDateForExceptionCase() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.FULLDATETIME", Date.class, SpecificationVersion.R02_04_02, null, null, ConformanceLevel.POPULATED, null, null);
		...
		context = ParserContextImpl.create("TS.FULLDATETIME", Date.class, SpecificationVersion.V01R04_3, null, null, ConformanceLevel.POPULATED, null, null);
		assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
    ...
    public void testParseDateTimeWithMissingTimezoneForNonCeRx() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.DATETIME", Date.class, SpecificationVersion.R02_04_02, null, null, ConformanceLevel.POPULATED, null, null);
        assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
    ...
    public void testParseDateTimeWithMissingTimezoneForCeRx() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.DATETIME", Date.class, SpecificationVersion.V01R04_3, null, null, ConformanceLevel.POPULATED, null, null);
        assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
    ...
    public void testParseFullDatePartTimeWithMissingTimezoneForNonCeRx() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.FULLDATEPARTTIME", Date.class, SpecificationVersion.R02_04_02, null, null, ConformanceLevel.POPULATED, null, null);
        assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
        assertEquals("has timezone missing error", 1, this.xmlResult.getHl7Errors().size());
    }
    ...
    public void testParseFullDatePartTimeWithMissingTimezoneForCeRx() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.FULLDATEPARTTIME", Date.class, SpecificationVersion.V01R04_3, null, null, ConformanceLevel.POPULATED, null, null);
        assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
        assertEquals("no timezone missing error", 0, this.xmlResult.getHl7Errors().size());
    }
    ...
    public void testParseNoFullDateTimeSpecificationTypeForAbstractFullDateWithTime() throws Exception {
        ...
        ParseContext context = ParserContextImpl.create("TS.FULLDATEWITHTIME", Date.class, SpecificationVersion.R02_04_02, null, null, ConformanceLevel.POPULATED, null, null);
        assertDateEquals("correct value returned " + value, FULL_DATE_TIME, expectedResult, (Date) (new TsElementParser()).parse(context, node, this.xmlResult).getBareValue());
...
//        assertTrue("no errors after relaxing validation", this.xmlResult.getHl7Errors().isEmpty());
	...
	public void dateShouldBeUnaffectedByDateTimeTimeZone() throws Exception {
		...
		String value = "20080625";
        Node node = createNode("<something value=\"" + value + "\" specializationType=\"TS.FULLDATE\" />");
		ParseContext context = ParserContextImpl.create("TS.FULLDATE", Date.class, SpecificationVersion.R02_04_02, null, TimeZone.getTimeZone("GMT-3"), ConformanceLevel.POPULATED, null, null, null, null);
	...
	public void shouldBeConvertedDueToTimeZone() throws Exception {
		...
		ParseContext context = ParserContextImpl.create("TS.FULLDATEWITHTIME", Date.class, SpecificationVersion.R02_04_02, null, TimeZone.getTimeZone("GMT-3"), ConformanceLevel.POPULATED, null, null, null, null);
		Date date = (Date)new TsElementParser().parse(context, node, this.xmlResult).getBareValue();
	...
	public void dateShouldBeAffectedByDateTimeZone() throws Exception {
		...
		String value = "20080625";
        Node node = createNode("<something value=\"" + value + "\" specializationType=\"TS.FULLDATE\" />");
		ParseContext context = ParserContextImpl.create("TS.FULLDATE", Date.class, SpecificationVersion.R02_04_02, TimeZone.getTimeZone("GMT-3"), null, ConformanceLevel.POPULATED, null, null, null, null);
		Date date = (Date)new TsElementParser().parse(context, node, this.xmlResult).getBareValue();
		assertDateEquals("should not be different even though different time zone", FULL_DATE, expectedResult, date);
	}
