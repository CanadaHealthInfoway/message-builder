...
public class Hl7SourceMapperBasicTest {
	...
	public void setUp() throws Exception {
		...
		Hl7MessageSource rootSource = new Hl7MessageSource(MockVersionNumber.MOCK.getVersionLiteral(), this.document, this.service);
	...
	public void shouldMapObservationAttributes() throws Exception {
		...
		Hl7MessageSource rootSource2 = new Hl7MessageSource(MockVersionNumber.MOCK.getVersionLiteral(), document2, this.service);
