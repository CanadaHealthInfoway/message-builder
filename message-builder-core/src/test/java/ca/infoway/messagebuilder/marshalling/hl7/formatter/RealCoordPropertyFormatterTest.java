...
public class RealCoordPropertyFormatterTest {
	...
	public void testGetAttributeNameValuePairsNullValue() throws Exception {
		Map<String,String>  result = new RealCoordPropertyFormatter().getAttributeNameValuePairs(new FormatContextImpl(this.modelToXmlResult, null, "name", null, null, null), null, new REALImpl());
	...
	public void testFormatCorrectly() throws Exception {
		...
		Map<String, String> result = new RealCoordPropertyFormatter().getAttributeNameValuePairs(new FormatContextImpl(this.modelToXmlResult, null, "name", null, null, null), new BigDecimal(realValue), null);
		assertEquals("map size", 1, result.size());
	...
	public void testValueHasTooManyDigitsToRightOfDecimal() throws Exception{
		...
		String result = new RealCoordPropertyFormatter().format(new FormatContextImpl(this.modelToXmlResult, null, "name", null, null, null), new REALImpl(bigDecimal));
