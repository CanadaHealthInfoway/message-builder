...
public class ListTelElementParserTest extends ParserTestCase {
	...
	public void testParse() throws Exception {
		...
		BareANY result = new ListElementParser().parse(ParserContextImpl.create("LIST<TEL.PHONEMAIL>", null, SpecificationVersion.V02R02, null, null, null, Cardinality.create("0-4")), 
	...
	public void testParseWithMinimumViolation() throws Exception {
		...
		BareANY result = new ListElementParser().parse(ParserContextImpl.create("LIST<TEL.PHONEMAIL>", null, SpecificationVersion.V02R02, null, null, null, Cardinality.create("3-5")), 
				asList(node.getChildNodes()), this.xmlResult);
	...
	public void testParseWithMaximumViolation() throws Exception {
		...
		BareANY result = new ListElementParser().parse(ParserContextImpl.create("LIST<TEL.PHONEMAIL>", null, SpecificationVersion.V02R02, null, null, null, Cardinality.create("1-2")), 
				asList(node.getChildNodes()), this.xmlResult);
