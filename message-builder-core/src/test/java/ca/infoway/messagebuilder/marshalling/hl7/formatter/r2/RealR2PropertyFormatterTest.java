...
public class RealR2PropertyFormatterTest {
	...
	public void testGetAttributeNameValuePairsNullValue() throws Exception {
		Map<String,String>  result = new RealR2PropertyFormatter().getAttributeNameValuePairs(new FormatContextImpl(this.modelToXmlResult, null, "name", "REAL", null, null, false), null, new REALImpl());
	...
	public void testFormatCorrectly() throws Exception {
		...
		Map<String, String> result = new RealR2PropertyFormatter().getAttributeNameValuePairs(new FormatContextImpl(this.modelToXmlResult, null, "name", "REAL", null, null, false), new BigDecimal(realValue), null);
		assertEquals("map size", 1, result.size());
	...
	public void testValueNegative() throws Exception{
		...
		String result = new RealR2PropertyFormatter().format(new FormatContextImpl(this.modelToXmlResult, null, "name", "REAL", null, null, false), new REALImpl(bigDecimal));
	...
	public void testOperatorNotAllowed() throws Exception{
		...
		String result = new RealR2PropertyFormatter().format(new FormatContextImpl(this.modelToXmlResult, null, "name", "REAL", null, null, false), dataType);
	...
	public void testSxcmOperatorAllowed() throws Exception{
		...
		String result = new RealR2PropertyFormatter().format(new FormatContextImpl(this.modelToXmlResult, null, "name", "SXCM<REAL>", null, null, false), dataType);
