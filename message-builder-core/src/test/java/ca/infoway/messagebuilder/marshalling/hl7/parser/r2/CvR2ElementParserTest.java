...
public class CvR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        CV_R2 cv = (CV_R2) this.parser.parse(
        		ParserContextImpl.create("CV", MockCharacters.class, V02R02, null, null, MANDATORY, null, null), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
	...
	public void testParseValidFullCo() throws Exception {
		...
		CO co = (CO) this.parser.parse(
				ParserContextImpl.create("CO", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null), 
				node, this.xmlResult);
		assertTrue("valid", this.xmlResult.isValid());
