...
public class EdElementParserTest extends CeRxDomainValueTestCase {
	...
	private ParseContext createContext() {
		return ParserContextImpl.create("ED", EncapsulatedData.class, SpecificationVersion.NEWFOUNDLAND.getVersionLiteral(), ConformanceLevel.POPULATED);
	}
	...
	private ParseContext createEdContext() {
		return ParserContextImpl.create("ED.DOCORREF", String.class, SpecificationVersion.V02R02.getVersionLiteral(), null);
	}
