...
public class PqrR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        PQR<MockCharacters> pqr = (PQR<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("PQR", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        PQR<MockCharacters> pqr = (PQR<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("PQR", MockCharacters.class, V02R02, null, null, MANDATORY, null, null, false), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParseContextImpl.create("PQR", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), node, this.xmlResult);
