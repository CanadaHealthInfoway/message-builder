...
public class SxcmCdR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        SXCM_R2<CodedTypeR2<MockCharacters>> cd = (SXCM_R2<CodedTypeR2<MockCharacters>>) this.parser.parse(
        		ParseContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        SXCM_R2<CodedTypeR2<MockCharacters>> cd = (SXCM_R2<CodedTypeR2<MockCharacters>>) this.parser.parse(
        		ParseContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, MANDATORY, null, null, false), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParseContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), node, this.xmlResult);
	...
	public void testParseValidFull() throws Exception {
		Node node = createNode("<something code=\"FRED\" codeSystem=\"1.2.3.4.5\" codeSystemName=\"aCsName\" codeSystemVersion=\"aCsVersion\" displayName=\"aDisplayName\" operator=\"P\">" +
		...
		assertEquals(SetOperator.PERIODIC_HULL, cd.getValue().getOperator());
	}
