...
public class SxcmCdR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        SXCM_R2<CodedTypeR2<? extends Code>> cd = (SXCM_R2<CodedTypeR2<? extends Code>>) this.parser.parse(
        		ParserContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, OPTIONAL, null), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        SXCM_R2<CodedTypeR2<? extends Code>> cd = (SXCM_R2<CodedTypeR2<? extends Code>>) this.parser.parse(
        		ParserContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, MANDATORY, null), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParserContextImpl.create("SXCM<CD>", MockCharacters.class, V02R02, null, null, OPTIONAL, null), node, this.xmlResult);
