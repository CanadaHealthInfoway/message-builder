...
public class RtoMoPqR2ElementParserTest extends CeRxDomainValueTestCase {

	@SuppressWarnings("unchecked")
	@Test
	public void testParseNullNode() throws Exception {
		Node node = createNode("<something nullFlavor=\"NI\" />");
		RTO<Money, PhysicalQuantity> rto = (RTO<Money, PhysicalQuantity>) new RtoMoPqR2ElementParser().parse(createContext(), node, this.xmlResult);
	...
	private ParseContext createContext() {
		return ParseContextImpl.create("RTO<MO,PQ>", Ratio.class, SpecificationVersion.V02R02, null, null, ConformanceLevel.POPULATED, null, null, false);
	}
	...
	public void testParseEmptyNode() throws Exception {
        ...
        Ratio<Money, PhysicalQuantity> ratio = (Ratio<Money, PhysicalQuantity>) new RtoMoPqR2ElementParser().parse(createContext(), node, this.xmlResult).getBareValue();
