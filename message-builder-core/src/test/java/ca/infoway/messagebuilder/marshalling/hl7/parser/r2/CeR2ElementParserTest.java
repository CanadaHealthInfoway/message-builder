...
public class CeR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        CE_R2 ce = (CE_R2) this.parser.parse(
        		ParserContextImpl.create("CE", MockCharacters.class, V02R02, null, null, OPTIONAL, null), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        CE_R2 ce = (CE_R2) this.parser.parse(
        		ParserContextImpl.create("CE", MockCharacters.class, V02R02, null, null, MANDATORY, null), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParserContextImpl.create("CE", MockCharacters.class, V02R02, null, null, OPTIONAL, null), node, this.xmlResult);
