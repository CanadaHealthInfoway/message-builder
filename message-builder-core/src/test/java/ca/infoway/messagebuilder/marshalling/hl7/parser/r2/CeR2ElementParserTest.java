...
public class CeR2ElementParserTest extends MarshallingTestCase {
    ...
    public void testParseNullNode() throws Exception {
        ...
        CE_R2<MockCharacters> ce = (CE_R2<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("CE", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), 
        		node, this.xmlResult);
    ...
    public void testParseEmptyNode() throws Exception {
        ...
        CE_R2<MockCharacters> ce = (CE_R2<MockCharacters>) this.parser.parse(
        		ParseContextImpl.create("CE", MockCharacters.class, V02R02, null, null, MANDATORY, null, null, false), 
        		node, this.xmlResult);
        assertTrue(this.xmlResult.isValid());
    ...
    public void testParseInvalidNullFavorAttributeValue() throws Exception {
        ...
        this.parser.parse(
        		ParseContextImpl.create("CE", MockCharacters.class, V02R02, null, null, OPTIONAL, null, null, false), node, this.xmlResult);
	...
	public void testParseValidFull() throws Exception {
		Node node = createNode("<something code=\"FRED\" codeSystem=\"1.2.3.4.5\" codeSystemName=\"aCsName\" codeSystemVersion=\"aCsVersion\" displayName=\"aDisplayName\">" +
								...
								"  <translation nullFlavor=\"OTH\" codeSystem=\"2.16.840.1.113883.5.1\" />" +
							   "</something>");
		...
		assertNull(ce.getValue().getTranslation().get(0).getNullFlavorForTranslationOnly());
		...
		assertNull(ce.getValue().getTranslation().get(1).getNullFlavorForTranslationOnly());
		assertNull(ce.getValue().getTranslation().get(2).getCode().getCodeValue());
		assertEquals(AdministrativeGender.FEMALE.getCodeSystem(), ce.getValue().getTranslation().get(2).getCode().getCodeSystem());
		assertEquals(NullFlavor.OTHER, ce.getValue().getTranslation().get(2).getNullFlavorForTranslationOnly());
	}
