...
public class SpecificationVersion extends EnumPattern implements VersionNumber {
	 ...
	 * Alberta
	 */
	public static final SpecificationVersion V01R04_1_AB = new SpecificationVersion("V01R04_1_AB", "Alberta (PIN)", Hl7BaseVersion.CERX);
	...
	public static final SpecificationVersion V01R04_3_NL = new SpecificationVersion("V01R04_3_NL", "NL Drug (CeRx)", Hl7BaseVersion.CERX);
