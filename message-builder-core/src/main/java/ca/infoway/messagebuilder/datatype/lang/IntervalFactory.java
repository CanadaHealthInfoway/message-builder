 ...
 * Last modified: $LastChangedDate: 2014-05-23 09:51:40 -0400 (Fri, 23 May 2014) $
 * Revision:      $LastChangedRevision: 8683 $
 */
...
public class IntervalFactory {
    ...
    /**
     * <p>Constructs a simple interval based on a single value and an operator.
     * 
     * @param <T> the type of the Interval
     * @param value the simple value for the Interval
     * @param operator the operator for the Interval
     * @return the constructed Interval
     */
	public static <T> Interval<T> createSimple(T value, SetOperator operator) {
