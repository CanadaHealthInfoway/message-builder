 ...
 */
public class CE_R2Impl extends ANYImpl<CodedTypeR2<? extends Code>> implements CE_R2 {
	/**
	 ...
	 */
	public CE_R2Impl(CodedTypeR2<? extends Code> defaultValue) {
		this(defaultValue, null, StandardDataType.CE);
	}
	 ...
	 */
	public CE_R2Impl(NullFlavor nullFlavor) {
		this(null, nullFlavor, StandardDataType.CE);
	}
	 ...
	 */
	public CE_R2Impl(CodedTypeR2<? extends Code> value, NullFlavor nullFlavor, StandardDataType dataType) {
