 ...
 */
public class CE_R2Impl<T extends Code> extends ANYImpl<CodedTypeR2<T>> implements CE_R2<T> {
	/**
	 ...
	 */
	public CE_R2Impl(CodedTypeR2<T> defaultValue) {
	 ...
	 */
	public CE_R2Impl(CodedTypeR2<T> value, NullFlavor nullFlavor, StandardDataType dataType) {
