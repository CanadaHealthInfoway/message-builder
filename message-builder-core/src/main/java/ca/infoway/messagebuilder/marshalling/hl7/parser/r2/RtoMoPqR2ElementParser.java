...
class RtoMoPqR2ElementParser extends AbstractRtoR2ElementParser<Money, PhysicalQuantity> {

	PqR2ElementParser pqParser = new PqR2ElementParser();
	MoR2ElementParser moParser = new MoR2ElementParser();
