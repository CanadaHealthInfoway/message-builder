...
public class CdaModelToXmlResult implements TransformErrors {

	private ModelToXmlResult delegate;
	...
	public String getXmlDocument() {
		return this.delegate.getXmlMessage();
	}

	public String getXmlDocumentWithoutFormatting() {
		return this.delegate.getXmlMessageWithoutFormatting();
	}
