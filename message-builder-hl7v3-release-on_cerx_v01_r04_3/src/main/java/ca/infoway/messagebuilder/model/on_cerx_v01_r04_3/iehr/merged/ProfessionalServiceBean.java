 ...
 * 
 * <p>REPC_MT100001ON.ProcedureEvent: Professional Service</p>
 * 
 ...
 * 
 * <p>REPC_MT000017ON.ProcedureEvent: Professional Service</p>
 * 
 * <p>A_BillableClinicalService</p>
 * 
 * <p>May be pertinent information with respect to a patient's 
 ...
 * or administered drug.</p>
 */
@Hl7PartTypeMapping({"REPC_MT000017ON.ProcedureEvent","REPC_MT100001ON.ProcedureEvent"})
@Hl7RootType
public class ProfessionalServiceBean extends MessagePartBean {
     ...
     * <p>Un-merged Business Name: (no business name specified)</p>
     * 
     * <p>Relationship: REPC_MT100001ON.ActRequest.author</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     * <p>Un-merged Business Name: (no business name specified)</p>
     * 
     * <p>Relationship: REPC_MT000017ON.ActRequest.author</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    ...
    @Hl7MapByPartTypes({
        @Hl7MapByPartType(name="subjectOf", type="REPC_MT000017ON.Subject2"),
        @Hl7MapByPartType(name="subjectOf/annotation", type="COCT_MT120600ON.Annotation"),
        @Hl7MapByPartType(name="subjectOf2", type="REPC_MT100001ON.Subject2"),
