...
import ca.infoway.messagebuilder.model.on_cerx_v01_r04_3.common.mcci_mt102001on.HL7MessageBean;



/**
 * <p>Business Name: MCCI_IN102002ON: Request Poll Queue Status</p>
 * 
 * <p>Requests an indication of the number and priority of 
 * outstanding interactions (if any) on the application's poll 
 * queue.</p>
 * 
 * <p>Message: MCCI_MT102001ON.Message</p>
 */
@Hl7PartTypeMapping({"MCCI_IN102002ON"})
