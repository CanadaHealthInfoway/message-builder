...
import ca.infoway.messagebuilder.model.on_cerx_v01_r04_3.common.mcci_mt000200on.HL7MessageBean;



/**
 * <p>Business Name: MCCI_IN102003ON: Return Poll Queue Status</p>
 * 
 * <p>Returns an indication of the number and priority of 
 * outstanding interactions (if any) on the application's poll 
 * queue.</p>
 * 
 * <p>Message: MCCI_MT000200ON.Message</p>
 */
@Hl7PartTypeMapping({"MCCI_IN102003ON"})
