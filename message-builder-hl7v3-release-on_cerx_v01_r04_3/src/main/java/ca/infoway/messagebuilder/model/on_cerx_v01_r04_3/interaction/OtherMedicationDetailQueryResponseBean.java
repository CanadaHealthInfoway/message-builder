...
import ca.infoway.messagebuilder.model.on_cerx_v01_r04_3.pharmacy.porx_mt060210on.OtherMedicationBean;



/**
 * <p>Business Name: PORX_IN060460ON: Other medication detail 
 * query response</p>
 * 
 ...
 * 
 * <p>--> Payload: PORX_MT060210ON.OtherMedication</p>
 * 
 * <p>--> Payload: PORX_MT060220ON.ParameterList</p>
 */
@Hl7PartTypeMapping({"PORX_IN060460ON"})
public class OtherMedicationDetailQueryResponseBean extends HL7Message_1Bean<TriggerEventBean<OtherMedicationBean,GenericQueryParametersBean>> implements InteractionBean {
