...
import ca.infoway.messagebuilder.model.newfoundland.cerx.refusal.RecordRefusalToDispenseRequestMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class RecordRefusalToDispenseRequestTransformationTest extends BaseTransformerTestCase {
	
	private static final String MESSAGE_FILE = "/ca/infoway/messagebuilder/sample/cerx/v01r04_3/recordRefusalToDispenseRequest.xml";
	...
	public void shouldMatchKnownRequest() throws Exception {
		RecordRefusalToDispenseRequestMessageBean model = createRequestBean();
	...
	private RecordRefusalToDispenseRequestMessageBean createRequestBean() {
		RecordRefusalToDispenseRequestMessageBean model = new RecordRefusalToDispenseRequestMessageBean();
		
		model.getControlActEvent().setCode(HL7TriggerEventCode.RECORD_REFUSAL_TO_DISPENSE_REQUEST);
		...
		model.getControlActEvent().setReasonCode(lookup(ActSupplyFulfillmentRefusalReason.class, "FRR02", CodeSystem.VOCABULARY_ACT_REASON.getRoot()));
