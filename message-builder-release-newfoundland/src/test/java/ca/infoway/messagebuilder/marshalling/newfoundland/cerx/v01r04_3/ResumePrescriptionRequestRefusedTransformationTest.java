...
import ca.infoway.messagebuilder.model.newfoundland.cerx.resume.ResumePrescriptionRequestRefusedMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class ResumePrescriptionRequestRefusedTransformationTest extends BaseTransformerTestCase {
	
	private static final String MESSAGE_FILE = "/ca/infoway/messagebuilder/sample/cerx/v01r04_3/resumePrescriptionRequestRefused.xml";
	...
	public void shouldMatchKnownRequest() throws Exception {
		ResumePrescriptionRequestRefusedMessageBean model = createResponseBean();
	...
	private ResumePrescriptionRequestRefusedMessageBean createResponseBean() {
		ResumePrescriptionRequestRefusedMessageBean refusedBean = new ResumePrescriptionRequestRefusedMessageBean();
		...
		refusedBean.getControlActEvent().setCode(HL7TriggerEventCode.RESUME_PRESCRIPTION_REQUEST_REFUSED);
