...
import ca.infoway.messagebuilder.model.newfoundland.cerx.refusal.RecordRefusalToDispenseRequestAcceptedMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class RecordRefusalToDispenseRequestAcceptedTransformationTest extends BaseTransformerTestCase {
	
	private static final String MESSAGE_FILE = "/ca/infoway/messagebuilder/sample/cerx/v01r04_3/recordRefusalToDispenseRequestAccepted.xml";
	...
	private RecordRefusalToDispenseRequestAcceptedMessageBean createResponseBean() {
		RecordRefusalToDispenseRequestAcceptedMessageBean acceptedBean = new RecordRefusalToDispenseRequestAcceptedMessageBean();
		...
		acceptedBean.getControlActEvent().setCode(HL7TriggerEventCode.RECORD_REFUSAL_TO_DISPENSE_REQUEST_ACCEPTED);
