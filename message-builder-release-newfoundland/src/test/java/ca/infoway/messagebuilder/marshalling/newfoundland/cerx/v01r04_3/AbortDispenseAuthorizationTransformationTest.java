...
import static ca.infoway.messagebuilder.domainvalue.transport.HL7TriggerEventCode.ABORT_DISPENSE_AUTHORIZATION_REQUEST;
import static ca.infoway.messagebuilder.domainvalue.transport.HL7TriggerEventCode.ABORT_DISPENSE_AUTHORIZATION_REQUEST_ACCEPTED;
import static ca.infoway.messagebuilder.domainvalue.transport.HL7TriggerEventCode.ABORT_DISPENSE_AUTHORIZATION_REQUEST_REFUSED;
...
import ca.infoway.messagebuilder.model.newfoundland.cerx.abort.AbortDispenseAuthorizationAcceptedMessageBean;
import ca.infoway.messagebuilder.model.newfoundland.cerx.abort.AbortDispenseAuthorizationMessageBean;
import ca.infoway.messagebuilder.model.newfoundland.cerx.abort.AbortDispenseAuthorizationRefusedMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class AbortDispenseAuthorizationTransformationTest extends BaseTransformerTestCase {
	
	private static final String REQUEST_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/abortDispenseAuthorizationRequest.xml";
	private static final String ACCEPTED_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/abortDispenseAuthorizationRequestAccepted.xml";
	private static final String REFUSED_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/abortDispenseAuthorizationRequestRefused.xml";
	...
	public void shouldMatchKnownAcceptedResponse() throws Exception {
		RecordResponseMessageBean<ActRequestBean> acceptedBean = new AbortDispenseAuthorizationAcceptedMessageBean();
	...
	private void populateAcceptedBean(RecordResponseMessageBean<ActRequestBean> acceptedBean) {
		...
		acceptedBean.getControlActEvent().setCode(ABORT_DISPENSE_AUTHORIZATION_REQUEST_ACCEPTED);
	...
	public void shouldMatchKnownRefusedResponse() throws Exception {
		RecordResponseMessageBean<ActRequestBean> refusedBean = new AbortDispenseAuthorizationRefusedMessageBean();
	...
	protected void populateRefusedBean(RecordResponseMessageBean<ActRequestBean> refusedBean) {
		...
		refusedBean.getControlActEvent().setCode(ABORT_DISPENSE_AUTHORIZATION_REQUEST_REFUSED);
	...
	private AbortDispenseAuthorizationMessageBean createRequestBean() {
		AbortDispenseAuthorizationMessageBean model = new AbortDispenseAuthorizationMessageBean();
		model.getControlActEvent().setCode(ABORT_DISPENSE_AUTHORIZATION_REQUEST);
