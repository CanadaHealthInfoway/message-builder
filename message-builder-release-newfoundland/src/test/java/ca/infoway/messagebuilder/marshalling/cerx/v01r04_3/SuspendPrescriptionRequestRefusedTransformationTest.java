...
import ca.infoway.messagebuilder.model.cerx.suspend.SuspendPrescriptionRequestRefusedMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class SuspendPrescriptionRequestRefusedTransformationTest extends BaseTransformerTestCase {
	
	private static final String MESSAGE_FILE = "/ca/infoway/messagebuilder/sample/cerx/v01r04_3/suspendPrescriptionRequestRefused.xml";
	...
	public void shouldMatchKnownRequest() throws Exception {
		SuspendPrescriptionRequestRefusedMessageBean model = createResponseBean();
	...
	private SuspendPrescriptionRequestRefusedMessageBean createResponseBean() {
		SuspendPrescriptionRequestRefusedMessageBean refusedBean = new SuspendPrescriptionRequestRefusedMessageBean();
		...
		refusedBean.getControlActEvent().setCode(HL7TriggerEventCode.SUSPEND_PRESCRIPTION_REQUEST_REFUSED);
