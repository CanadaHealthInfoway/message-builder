...
import ca.infoway.messagebuilder.model.newfoundland.cerx.suspend.SuspendPrescriptionRequestMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class SuspendPrescriptionRequestTransformationTest extends BaseTransformerTestCase {
	
	private static final String MESSAGE_FILE = "/ca/infoway/messagebuilder/sample/cerx/v01r04_3/suspendPrescriptionRequest.xml";
	...
	private SuspendPrescriptionRequestMessageBean createRequestBean() {
		SuspendPrescriptionRequestMessageBean model = new SuspendPrescriptionRequestMessageBean();
		
		model.getControlActEvent().setCode(HL7TriggerEventCode.SUSPEND_PRESCRIPTION_REQUEST);
