...
import ca.infoway.messagebuilder.model.newfoundland.cerx.immunization.RetractImmunizationAcceptedMessageBean;
import ca.infoway.messagebuilder.model.newfoundland.cerx.immunization.RetractImmunizationMessageBean;
import ca.infoway.messagebuilder.model.newfoundland.cerx.immunization.RetractImmunizationRefusedMessageBean;
import ca.infoway.messagebuilder.util.xml.ClasspathResource;

public class RetractImmunizationTransformationTest extends BaseTransformerTestCase {
	
	private static final String RETRACT_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/retractImmunizationRequest.xml";
	private static final String ACCEPTED_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/retractImmunizationRequestAccepted.xml";
	private static final String REFUSED_MESSAGE_FILE = "ca/infoway/messagebuilder/sample/cerx/v01r04_3/retractImmunizationRequestRefused.xml";
	...
	private void populateAcceptedBean(RecordResponseMessageBean<ActEventBean> acceptedBean) {
		...
		acceptedBean.getControlActEvent().setCode(HL7TriggerEventCode.RETRACT_IMMUNIZATION_REQUEST_ACCEPTED);
...
System.out.println(xml);		
	...
	protected void populateRefusedBean(RecordResponseMessageBean<ActEventBean> refusedBean) {
		...
		refusedBean.getControlActEvent().setCode(HL7TriggerEventCode.RETRACT_IMMUNIZATION_REQUEST_REFUSED);
	...
	private RetractImmunizationMessageBean createRequestBean() {
		RetractImmunizationMessageBean model = new RetractImmunizationMessageBean();
		model.getControlActEvent().setCode(HL7TriggerEventCode.RETRACT_IMMUNIZATION_REQUEST);
