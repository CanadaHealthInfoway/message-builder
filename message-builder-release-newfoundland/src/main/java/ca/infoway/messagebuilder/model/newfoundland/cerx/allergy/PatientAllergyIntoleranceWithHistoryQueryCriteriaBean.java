...
public class PatientAllergyIntoleranceWithHistoryQueryCriteriaBean extends PatientQueryCriteria {

    private static final long serialVersionUID = 7691578448165258133L;

    private II conditionId = new IIImpl();
    ...
    public void setConditionId(Identifier conditionId) {
        this.conditionId.setValue(conditionId);
    }
}
