...
public class IndeterminatePersonBean extends MessagePartBean implements IndeterminatePerson, Serializable {
    ...
    private final Set<OtherIdentifiersBean> asOtherIds = Collections.synchronizedSet(new LinkedHashSet<OtherIdentifiersBean>());

    private final List<PersonalRelationshipBean> personalRelationships = Collections.synchronizedList(new ArrayList<PersonalRelationshipBean>());

    private final Set<LanguageCommunicationBean> languageCommunications = Collections.synchronizedSet(new LinkedHashSet<LanguageCommunicationBean>());
    ...
    public String toString() {
        return new ToStringBuilder(null).append("administrativeGenderCode", getAdministrativeGenderCode()).append("birthTime", getBirthTime()).append("names", getNames()).toString();
    }
}
