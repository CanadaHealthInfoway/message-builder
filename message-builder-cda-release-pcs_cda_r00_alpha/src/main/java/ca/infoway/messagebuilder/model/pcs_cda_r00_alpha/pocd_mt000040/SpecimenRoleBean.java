...
@Hl7PartTypeMapping({"POCD_MT000040.SpecimenRole"})
public class SpecimenRoleBean extends MessagePartBean {
    ...
    private PlayingEntityBean specimenPlayingEntity;
     ...
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    @Hl7XmlMapping({"specimenPlayingEntity"})
    public PlayingEntityBean getSpecimenPlayingEntity() {
     ...
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    public void setSpecimenPlayingEntity(PlayingEntityBean specimenPlayingEntity) {
