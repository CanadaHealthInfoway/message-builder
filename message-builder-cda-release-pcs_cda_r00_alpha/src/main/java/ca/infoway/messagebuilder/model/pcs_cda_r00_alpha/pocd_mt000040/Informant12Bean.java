...
@Hl7PartTypeMapping({"POCD_MT000040.Informant12"})
public class Informant12Bean extends MessagePartBean {
    ...
    public AssignedEntityBean getInformant12ChoiceAsAssignedEntity() {
        return this.informant12Choice instanceof AssignedEntityBean ? (AssignedEntityBean) this.informant12Choice : null;
    }
    public boolean hasInformant12ChoiceAsAssignedEntity() {
        return (this.informant12Choice instanceof AssignedEntityBean);
    }
