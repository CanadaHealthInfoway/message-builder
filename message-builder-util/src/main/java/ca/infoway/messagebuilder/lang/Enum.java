...
public abstract class Enum implements Comparable, Serializable {
    ...
    private static Entry getEntry(Class enumClass) {
        ...
        if (!cEnumClasses.containsKey(enumClass)) {
    ...
    private static void forciblyLoadClass(Class enumClass) {
		try {
    ...
    public int compareTo(Object other) {
        ...
        if (other.getClass() != this.getClass()) {
            ...
            throw new ClassCastException(
                    "Different enum class '" + Enum.getShortClassName(other.getClass()) + "'");
        }
    ...
    public String toString() {
        if (iToString == null) {
            String shortName = Enum.getShortClassName(getEnumClass());
