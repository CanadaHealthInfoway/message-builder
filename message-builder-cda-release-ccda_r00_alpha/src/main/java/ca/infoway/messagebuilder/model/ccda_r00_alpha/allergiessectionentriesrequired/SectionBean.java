...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_2;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_2> entry = new ArrayList<EntryChoice_2>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_2> getEntry() {
        return this.entry;
    }
