...
package ca.infoway.messagebuilder.model.ccda_r00_alpha.allergiessectionentriesoptional;
...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.Entry_2Bean;
...
@Hl7PartTypeMapping({"AllergiesSectionentriesOptional.Section"})
@Hl7RootType
public class SectionBean extends MessagePartBean {
    ...
    private List<Entry_2Bean> entry = new ArrayList<Entry_2Bean>();
    private List<Component4Bean> component = new ArrayList<Component4Bean>();


    /**
     * <p>Relationship: AllergiesSectionentriesOptional.Section.ID</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.classCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.moodCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.realmCode</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.typeId</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.templateId</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.title</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"title"})
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.text</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"text"})
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.confidentialityCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.languageCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.subject</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.author</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.informant</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.entry</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    @Hl7XmlMapping({"entry"})
    public List<Entry_2Bean> getEntry() {
        return this.entry;
    }
    ...
    /**
     * <p>Relationship: 
     * AllergiesSectionentriesOptional.Section.component</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
