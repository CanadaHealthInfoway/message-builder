...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_6;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_6> entry = new ArrayList<EntryChoice_6>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_6> getEntry() {
        return this.entry;
    }
