...
package ca.infoway.messagebuilder.model.ccda_r00_alpha.resultssectionentriesoptional;
...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.Entry_9Bean;
...
@Hl7PartTypeMapping({"ResultsSectionentriesOptional.Section"})
@Hl7RootType
public class SectionBean extends MessagePartBean {
    ...
    private List<Entry_9Bean> entry = new ArrayList<Entry_9Bean>();
    private List<Component4Bean> component = new ArrayList<Component4Bean>();


    /**
     * <p>Relationship: ResultsSectionentriesOptional.Section.ID</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.classCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.moodCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.realmCode</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.typeId</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.templateId</p>
     * 
    ...
    /**
     * <p>Relationship: ResultsSectionentriesOptional.Section.title</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"title"})
    ...
    /**
     * <p>Relationship: ResultsSectionentriesOptional.Section.text</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"text"})
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.confidentialityCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.languageCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.subject</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.author</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.informant</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: ResultsSectionentriesOptional.Section.entry</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    @Hl7XmlMapping({"entry"})
    public List<Entry_9Bean> getEntry() {
        return this.entry;
    }
    ...
    /**
     * <p>Relationship: 
     * ResultsSectionentriesOptional.Section.component</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
