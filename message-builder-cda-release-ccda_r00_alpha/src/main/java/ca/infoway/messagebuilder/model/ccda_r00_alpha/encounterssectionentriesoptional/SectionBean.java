...
package ca.infoway.messagebuilder.model.ccda_r00_alpha.encounterssectionentriesoptional;
...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.Entry_4Bean;
...
@Hl7PartTypeMapping({"EncountersSectionentriesOptional.Section"})
@Hl7RootType
public class SectionBean extends MessagePartBean {
    ...
    private List<Entry_4Bean> entry = new ArrayList<Entry_4Bean>();
    private List<Component4Bean> component = new ArrayList<Component4Bean>();


    /**
     * <p>Relationship: EncountersSectionentriesOptional.Section.ID</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.classCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.moodCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.realmCode</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.typeId</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.templateId</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.title</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"title"})
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.text</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"text"})
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.confidentialityCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.languageCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.subject</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.author</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.informant</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.entry</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    @Hl7XmlMapping({"entry"})
    public List<Entry_4Bean> getEntry() {
        return this.entry;
    }
    ...
    /**
     * <p>Relationship: 
     * EncountersSectionentriesOptional.Section.component</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
