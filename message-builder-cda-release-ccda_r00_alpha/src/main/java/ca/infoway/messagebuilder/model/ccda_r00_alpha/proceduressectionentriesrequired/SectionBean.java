...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_8;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_8> entry = new ArrayList<EntryChoice_8>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_8> getEntry() {
        return this.entry;
    }
