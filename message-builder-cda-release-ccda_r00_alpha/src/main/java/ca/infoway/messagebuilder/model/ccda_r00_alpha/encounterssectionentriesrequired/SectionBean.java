...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.EntryChoice_4;
...
public class SectionBean extends MessagePartBean {
    ...
    private List<EntryChoice_4> entry = new ArrayList<EntryChoice_4>();
     ...
     */
    @Hl7XmlMapping({"entry"})
    public List<EntryChoice_4> getEntry() {
        return this.entry;
    }
