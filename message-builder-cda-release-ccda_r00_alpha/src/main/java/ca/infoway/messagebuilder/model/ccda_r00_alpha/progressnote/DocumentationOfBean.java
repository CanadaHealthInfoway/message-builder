...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.Performer1_1Bean;
...
@Hl7PartTypeMapping({"ProgressNote.DocumentationOf"})
public class DocumentationOfBean extends MessagePartBean {
    ...
    private II serviceEventTemplateId = new IIImpl();
    ...
    /**
     * <p>Relationship: ProgressNote.DocumentationOf.typeCode</p>
     * 
    ...
    /**
     * <p>Relationship: ProgressNote.ServiceEvent.moodCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    public Identifier getServiceEventTemplateId() {
        return this.serviceEventTemplateId.getValue();
    }
     ...
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    public void setServiceEventTemplateId(Identifier serviceEventTemplateId) {
        this.serviceEventTemplateId.setValue(serviceEventTemplateId);
    }
