...
package ca.infoway.messagebuilder.model.ccda_r00_alpha.vitalsignssectionentriesoptional;
...
import ca.infoway.messagebuilder.model.ccda_r00_alpha.merged.Entry_10Bean;
...
@Hl7PartTypeMapping({"VitalSignsSectionentriesOptional.Section"})
@Hl7RootType
public class SectionBean extends MessagePartBean {
    ...
    private List<Entry_10Bean> entry = new ArrayList<Entry_10Bean>();
    private List<Component4Bean> component = new ArrayList<Component4Bean>();


    /**
     * <p>Relationship: VitalSignsSectionentriesOptional.Section.ID</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.classCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.moodCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.realmCode</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.typeId</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.templateId</p>
     * 
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.title</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"title"})
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.text</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    @Hl7XmlMapping({"text"})
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.confidentialityCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.languageCode</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.subject</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.author</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.informant</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.entry</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
    @Hl7XmlMapping({"entry"})
    public List<Entry_10Bean> getEntry() {
        return this.entry;
    }
    ...
    /**
     * <p>Relationship: 
     * VitalSignsSectionentriesOptional.Section.component</p>
     * 
     * <p>Conformance/Cardinality: OPTIONAL (0-*)</p>
     */
