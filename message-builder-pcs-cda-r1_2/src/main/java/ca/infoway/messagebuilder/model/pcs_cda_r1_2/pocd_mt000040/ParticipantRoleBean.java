...
@Hl7PartTypeMapping({"POCD_MT000040.ParticipantRole"})
public class ParticipantRoleBean extends MessagePartBean {
    ...
    public PlayingEntityBean getParticipantRoleChoiceAsPlayingEntity() {
        return this.participantRoleChoice instanceof PlayingEntityBean ? (PlayingEntityBean) this.participantRoleChoice : null;
    }
    public boolean hasParticipantRoleChoiceAsPlayingEntity() {
        return (this.participantRoleChoice instanceof PlayingEntityBean);
    }
