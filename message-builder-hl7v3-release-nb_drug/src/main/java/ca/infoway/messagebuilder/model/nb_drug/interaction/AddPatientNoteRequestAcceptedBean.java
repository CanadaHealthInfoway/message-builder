...
/**
 * <p>Business Name: COMT_IN300002NB: Add patient note request 
 * accepted</p>
 * 
 ...
 * added patient note record and the patient identifier(PDID) 
 * against which the note was applied which will match the 
 * patient specified in request message.</p>
 * 
 ...
 */
@Hl7PartTypeMapping({"COMT_IN300002NB"})
