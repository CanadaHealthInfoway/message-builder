 ...
 * note record identifier was not valid or could not be 
 * resolved. b. The patient record identifier supplied in the 
 * request message was not valid. c. The user attempting to 
 * deprecate the note is not the original author of the note. 
 * d. One or more code values supplied in the message were 
 * invalid.</p> <p></p>
 * 
