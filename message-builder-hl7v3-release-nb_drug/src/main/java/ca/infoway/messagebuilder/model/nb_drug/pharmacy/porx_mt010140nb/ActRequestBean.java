...
package ca.infoway.messagebuilder.model.nb_drug.pharmacy.porx_mt010140nb;
...
@Hl7PartTypeMapping({"PORX_MT010140NB.ActRequest"})
public class ActRequestBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PORX_MT010140NB.ActRequest.id</p>
     * 
     ...
     * 
     * <p>This must be a valid prescription identifier for the 
     * prescription that is having its dispense responsibility 
     * reassigned. The prescription must be either 
     * &quot;Active&quot; or &quot;Suspended&quot; and the current 
     * custodian of this prescription must be the one issuing this 
     * Revise Assigned Dispense Responsibility Request.</p>
     */
    @Hl7XmlMapping({"id"})
    ...
    /**
     * <p>Relationship: 
     * PORX_MT010140NB.Precondition.verificationEventCriterion</p>
     * 
