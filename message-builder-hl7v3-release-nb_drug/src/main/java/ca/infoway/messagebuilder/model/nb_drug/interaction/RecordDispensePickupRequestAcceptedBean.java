...
/**
 * <p>Business Name: PORX_IN020090NB: Record dispense pickup 
 * request accepted</p>
 * 
 ...
 * element that returns the record identifier of the dispense 
 * record and the patient identifier against which the dispense 
 * pickup was applied which will match the patient specified in 
 * request message.</p>
 * 
 ...
 */
@Hl7PartTypeMapping({"PORX_IN020090NB"})
