...
import ca.infoway.messagebuilder.model.nb_drug.merged.AllergyIntoleranceSeverityLevelBean;
 ...
 * 
 * <p>REPC_MT000009NB.ObservationEvent: (no business name)</p>
 * 
 ...
 * 
 * <p>REPC_MT000013NB.ObservationEvent: (no business name)</p>
 * 
 * <p>If code is SNOMED, value is not permitted, otherwise it 
 * is mandatory and code must be '''DX'''</p>
 * 
 * <p>REPC_MT000001NB.ObservationEvent: (no business name)</p>
 * 
 ...
 * 
 * <p><span style="font-family: Arial; ">If the 
 * allergy/intolerance is being added to an existing Adverse 
 * Reaction record in the DIS, a valid DIS ADR record 
 * identifier must be specified in the &ldquo;id&rdquo; element 
 * in the message path &ldquo;/subject /intoleranceCondition 
 * /support /causalityAssessment /subject 
 * /observationEvent&rdquo; and the &ldquo;code&rdquo; element 
 * should be set to the fixed value of &ldquo;DX&rdquo; and the 
 * &ldquo;statusCode&rdquo; element should be set to the fixed 
 * value of &ldquo;COMPLETED&rdquo;. To create a new ADR 
 * record, the &ldquo;observationEvent&rdquo; element should be 
 * fully specified including an &ldquo;effectiveTime&rdquo; 
 * element specified with format YYYYMMDD for the date, and a 
 * &ldquo;value&rdquo; element specified using ICD-10-CA, and 
 * the &ldquo;severityObservation&rdquo; element in the 
 * &ldquo;subjectOf&rdquo; element should be set with an 
 * appropriate &ldquo;code&rdquo;, &ldquo;statusCode&rdquo;, 
 * and &ldquo;value&rdquo; element that specifies the severity 
 * &ldquo;H&rdquo;, &ldquo;M&rdquo;, &ldquo;L&rdquo; (as per 
 * the SeverityObservation vocabulary) for the ADR as well as 
 * its current status as shown in the sample messages. 
 * </span></p>
 */
