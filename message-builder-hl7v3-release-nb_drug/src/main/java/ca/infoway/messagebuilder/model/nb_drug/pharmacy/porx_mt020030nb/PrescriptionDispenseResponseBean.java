...
package ca.infoway.messagebuilder.model.nb_drug.pharmacy.porx_mt020030nb;
 ...
 * been accepted</p>
 */
@Hl7PartTypeMapping({"PORX_MT020030NB.SupplyEvent"})
@Hl7RootType
public class PrescriptionDispenseResponseBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PORX_MT020030NB.SupplyEvent.id</p>
     * 
     ...
     * 
     * <p>For drug and device prescription dispenses this will be 
     * the dispense record identifier.</p> <p>For supply event 
     * (ward stock) this will be the office supply record 
     * identifier (supply event record).</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * 
     * <p>Relationship: PORX_MT020030NB.ActRequest.id</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
