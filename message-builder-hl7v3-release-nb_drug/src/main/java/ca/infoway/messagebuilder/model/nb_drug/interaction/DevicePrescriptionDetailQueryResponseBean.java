 ...
 * deviceRequest&rdquo; elements and one or more errors will be 
 * returned in &ldquo;detectedIssueEvent&rdquo; elements in the 
 * message path: &ldquo;/subjectOf&rdquo;. Potential reasons 
 * for an error may include parameters specified in the query 
