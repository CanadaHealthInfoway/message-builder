...
@Hl7PartTypeMapping({"PORX_MT020070NB.SupplyEvent"})
public class SupplyEventBean extends MessagePartBean {
     ...
     * 
     * <p>At minimum the &ldquo;low&rdquo; element of the 
     * &ldquo;effectiveTime&rdquo; element must be specified using 
     * YYYYMMDD format indicating the date of the dispense.</p>
     */
