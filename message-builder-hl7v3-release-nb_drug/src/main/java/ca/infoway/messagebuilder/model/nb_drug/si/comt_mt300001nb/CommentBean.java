...
package ca.infoway.messagebuilder.model.nb_drug.si.comt_mt300001nb;
 ...
 * Patient's record.</p>
 */
@Hl7PartTypeMapping({"COMT_MT300001NB.Annotation"})
@Hl7RootType
public class CommentBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: COMT_MT300001NB.Annotation.code</p>
     * 
     ...
     * 
     * <p>The &ldquo;code&rdquo; element in the message path 
     * &ldquo;/subject /annotation&rdquo; must specify an 
     * appropriate category for the annotation using the 
     * ActPatientAnnotationCode vocabulary. Generally, this value 
     * would either be &ldquo;GEN&rdquo; for generic alert or 
     * &ldquo;PI&rdquo; for patient instructions.</p>
     */
    @Hl7XmlMapping({"code"})
     ...
     * 
     * <p>Relationship: COMT_MT300001NB.Annotation.text</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
    ...
    /**
     * <p>Relationship: COMT_MT300001NB.RecordTarget.patient</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     * <p>A valid patient identifier (PDID) must be specified that 
     * matches the patient to which the record specified belongs. 
     * The patient identifier is specified in the &ldquo;id&rdquo; 
     * element in the message path &ldquo;/subject /annotation 
     * /subject /annotatedAct /subject /patient&rdquo;.</p>
     */
