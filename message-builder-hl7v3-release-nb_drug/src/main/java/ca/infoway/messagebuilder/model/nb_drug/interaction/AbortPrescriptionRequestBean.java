...
/**
 * <p>Business Name: PORX_IN010840NB: Abort prescription 
 * request</p>
 * 
 * <p>Requests that the specified prescription be aborted 
 * (further dispensing or administrative must cease).</p>
 * 
 * <p>The current status of prescription records must be set to 
 * &ldquo;Active&rdquo; or &ldquo;Suspended&rdquo; for this 
 * request message to be processed. Any other state will result 
 * in a rejection message from the DIS.</p>
 * 
 ...
 */
@Hl7PartTypeMapping({"PORX_IN010840NB"})
