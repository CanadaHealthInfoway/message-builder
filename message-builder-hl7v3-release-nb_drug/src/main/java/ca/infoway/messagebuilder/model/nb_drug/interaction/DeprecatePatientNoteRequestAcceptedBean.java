...
/**
 * <p>Business Name: COMT_IN300102NB: Deprecate patient note 
 * request accepted</p>
 * 
 ...
 * element that returns the record identifier of the patient 
 * note that has just been deprecated and the patient record 
 * against which the patient note was applied to which matches 
 ...
 */
@Hl7PartTypeMapping({"COMT_IN300102NB"})
public class DeprecatePatientNoteRequestAcceptedBean extends HL7MessageBean<TriggerEventBean<ReferencedRecordBean>> implements InteractionBean {
