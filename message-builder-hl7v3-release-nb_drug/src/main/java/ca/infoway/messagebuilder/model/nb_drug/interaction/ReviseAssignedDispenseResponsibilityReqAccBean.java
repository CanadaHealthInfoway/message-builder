 ...
 * 
 * <p>The receipt of this message confirms the transfer has 
 * been completed. The message includes a copy of the 
 * transferred prescription in the &ldquo;subject&rdquo; 
 * element which would either be a 
 * &ldquo;combinedMedicationRequest&rdquo; element for drug 
