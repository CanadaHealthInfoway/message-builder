...
/**
 * <p>Business Name: COMT_IN600002NB: Retract action request 
 * accepted</p>
 * 
 ...
 * the event.</p>
 * 
 * <p>This response message is confirmation that the associated 
 * request message to retract an action has been processed by 
 * the DIS and the action was successfully retracted.</p>
 * 
 ...
 */
@Hl7PartTypeMapping({"COMT_IN600002NB"})
