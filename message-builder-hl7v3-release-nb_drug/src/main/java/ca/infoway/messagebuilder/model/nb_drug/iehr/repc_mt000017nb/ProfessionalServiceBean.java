...
package ca.infoway.messagebuilder.model.nb_drug.iehr.repc_mt000017nb;
...
import ca.infoway.messagebuilder.model.nb_drug.iehr.merged.OrderForServiceBean;
 ...
 */
@Hl7PartTypeMapping({"REPC_MT000017NB.ProcedureEvent"})
@Hl7RootType
public class ProfessionalServiceBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: REPC_MT000017NB.ProcedureEvent.code</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * REPC_MT000017NB.ProcedureEvent.effectiveTime</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * REPC_MT000017NB.ProcedureEvent.confidentialityCode</p>
     * 
    ...
    /**
     * <p>Relationship: REPC_MT000017NB.Subject.patient</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
    ...
    /**
     * <p>Relationship: REPC_MT000017NB.InFulfillmentOf.actRequest</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     */
    ...
    /**
     * <p>Relationship: REPC_MT000017NB.Subject2.annotation</p>
     * 
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     * <p>Optionally, if there are any relevant notes to attach 
     * against this professional service, they may be entered in 
     * the &ldquo;text&rdquo; element in the message path 
     * &ldquo;/subject /procedureEvent /subjectOf 
     * /annotation&rdquo;. The &ldquo;languageCode&rdquo; and 
     * &ldquo;author&rdquo; elements in this message path must be 
     * specified as well and the &ldquo;statusCode&rdquo; element 
     * set to a fixed value of &ldquo;COMPLETED&rdquo;.</p>
     */
