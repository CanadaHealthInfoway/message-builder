...
package ca.infoway.messagebuilder.model.nb_drug.pharmacy.porx_mt040020nb;
 ...
 */
@Hl7PartTypeMapping({"PORX_MT040020NB.OtherMedication"})
@Hl7RootType
public class OtherMedicationBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: PORX_MT040020NB.OtherMedication.id</p>
     * 
     ...
     * be updated.</p>
     * 
     * <p>The &ldquo;id&rdquo; element must specify a valid DIS 
     * record identifier for a non-prescribed medication and on the 
     * patient&rsquo;s profile. This identifier must match either 
     * the identifier returned in the &quot;Record other medication 
     * request accepted (PORX_IN040030CA)&rdquo; response message 
     * returned against a newly added record or an identifier 
     * returned in the &ldquo;Other medication detail query 
     * response (PORX_IN060460CA)&rdquo; query response message 
     * against the patient&rsquo;s DIS profile.</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * 
     * <p>Relationship: PORX_MT040020NB.OtherMedication.code</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     ...
     * 
     * <p>Relationship: PORX_MT040020NB.OtherMedication.statusCode</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     ...
     * 
     * <p>Relationship: 
     * PORX_MT040020NB.OtherMedication.effectiveTime</p>
     * 
     ...
     * 
     * <p>Relationship: PORX_MT040020NB.OtherMedication.routeCode</p>
     * 
    ...
    /**
     * <p>Relationship: PORX_MT040020NB.Subject10.patient</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     */
