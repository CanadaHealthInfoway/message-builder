 ...
 * force.</p>
 * 
 * <p>The receipt of this message means the request to retract 
 * an action has been rejected by the DIS. The common causes 
 * for the rejection of a retract request include exceeding the 
 * timeframe policy for the retraction of a specific item or 
 * attempting to retract an item that may not be retracted. 
 * </p> <p>The &ldquo;text&rdquo; element in the message path 
