 ...
 * be recorded.</p>
 * 
 * <p>If any notes are applicable to the supply request, they 
 * may be specified in the &ldquo;text&rdquo; element in the 
 * message path &ldquo;/subject /supplyEvent /subjectOf 
