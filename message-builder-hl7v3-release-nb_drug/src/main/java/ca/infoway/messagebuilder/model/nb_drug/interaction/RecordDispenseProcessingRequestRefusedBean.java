...
/**
 * <p>Business Name: PORX_IN020140NB: Record dispense 
 ...
 * dispense request message, such as a prescription, provider, 
 * or patient identifier were not valid or could not be 
 * resolved. <br /> b. Drugs were not specified using a HC-DIN 
 * or NPN or the supplied values were invalid.<br /> c. A 
 * dispense was attempted against a prescription that is no 
 * longer active or did not allow a dispense to be executed 
 * with the supplied criteria.<br /> d. The prescription that 
 * the dispense request refers to is assigned to another 
 * dispensing facility.<br /> e. One or more code values 
 ...
 */
@Hl7PartTypeMapping({"PORX_IN020140NB"})
