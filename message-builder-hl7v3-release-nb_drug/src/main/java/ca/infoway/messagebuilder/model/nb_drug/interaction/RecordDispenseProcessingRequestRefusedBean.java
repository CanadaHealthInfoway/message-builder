 ...
 * resolved. b. Drugs were not specified using a HC-DIN or NPN 
 * or the supplied values were invalid. c. A dispense was 
 * attempted against a prescription that is no longer active or 
 * did not allow a dispense to be executed with the supplied 
 * criteria. d. The prescription that the dispense request 
 * refers to is assigned to another dispensing facility. e. One 
 * or more code values supplied in the message were 
 * invalid.</p>
 * 
