 ...
 * refused by the DIS include: a. The patient record identifier 
 * supplied in the request message was not valid. b. The 
 * location record identifier supplied in the request message 
 * was not valid. c. The note exceeded 2,000 characters in 
 * length. d. One or more code values supplied in the message 
 * were invalid.</p> <p></p>
 * 
