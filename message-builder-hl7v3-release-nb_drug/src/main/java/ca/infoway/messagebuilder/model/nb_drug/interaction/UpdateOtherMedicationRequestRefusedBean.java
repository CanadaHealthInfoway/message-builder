...
/**
 * <p>Business Name: PORX_IN040090NB: Update other medication 
 * request refused</p>
 * 
 ...
 * message may include:<br /> a. The patient identifier was not 
 * a valid provincial client identifier.<br /> b. The 
 * identifier for the existing DIS 
 * &ldquo;otherMedication&rdquo; record was not valid.<br /> c. 
 ...
 */
@Hl7PartTypeMapping({"PORX_IN040090NB"})
