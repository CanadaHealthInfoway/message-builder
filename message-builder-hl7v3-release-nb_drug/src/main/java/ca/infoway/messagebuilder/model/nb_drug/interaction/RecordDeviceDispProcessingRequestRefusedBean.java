...
/**
 * <p>Business Name: PORX_IN020330NB: Record device disp. 
 ...
 * be resolved. <br /> b. Devices were not specified using 
 * OPINION PINs or the supplied values were invalid.<br /> c. A 
 * dispense was attempted against a device prescription that is 
 * no longer active or did not allow a device dispense to be 
 * executed with the supplied criteria.<br /> d. The device 
 * prescription that the dispense request refers to is assigned 
 * to another dispensing facility.<br /> e. One or more code 
 ...
 */
@Hl7PartTypeMapping({"PORX_IN020330NB"})
