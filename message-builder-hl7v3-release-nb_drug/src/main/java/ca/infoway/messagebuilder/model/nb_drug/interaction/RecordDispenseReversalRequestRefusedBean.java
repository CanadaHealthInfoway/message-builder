 ...
 * transfer request message, such as the dispense or patient 
 * identifier, were not valid or could not be resolved. <br /> 
 * b. The dispense is in a status that does not allow a 
 * reversal &ndash; dispenses that are either 
 * &ldquo;Active&rdquo; or &ldquo;Completed&rdquo; may be 
