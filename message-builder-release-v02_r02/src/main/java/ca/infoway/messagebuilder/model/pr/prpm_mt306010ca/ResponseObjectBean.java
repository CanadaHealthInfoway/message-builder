 ...
 * follows:</p>
 * 
 * <p><ResponseObject><value 
 * code="HealthCareProvider.id"/></ResponseObject></p>
 * 
 * <p><ResponseObject><value 
 * code="PrincipalPerson.name"/></ResponseObject></p>
 * 
 * <p><ResponseObject><value 
 * code="ServiceDeliveryLocation"/></ResponseObject></p>
 * 
 * <p>Utilized to support cases when a source or consumer (such 
 * as a Health Authority) wants only specific information about 
 * a given set of providers. For example, a HA might want to 
 * know all the Work Locations for a given provider type, and 
 * wouldn't want to receive all information. The type of 
 * information expected in the response is provided via the 
 * response object.</p>
 * 
