 ...
 * 
 * <p><p>Reason / rationale that explain the adjudication 
 * results.</p></p>
 */
...
public class AdjudicationResultReasonBean extends MessagePartBean implements ca.infoway.messagebuilder.model.pcs_mr2007_v02_r02.claims.merged.AdjudicationCodeChoice {
     ...
     * results.</p></p>
     * 
     * <p><p>Domain is ActAdjudicationReason.</p><p>A subset of 
     * these codes may be included in the COB CMET for downstream 
     * adjudicators due to privacy concerns/legislation.</p></p>
     * 
     * <p><p>Domain is ActAdjudicationReason.</p><p>A subset of 
     * these codes may be included in the COB CMET for downstream 
     * adjudicators due to privacy concerns/legislation.</p></p>
