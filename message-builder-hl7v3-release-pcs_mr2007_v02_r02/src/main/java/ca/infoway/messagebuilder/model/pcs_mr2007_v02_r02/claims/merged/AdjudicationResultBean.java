...
public class AdjudicationResultBean extends MessagePartBean {
     ...
     * 
     * <p><p>For Adjudication Results: Can be any code from the 
     * ActAdjudicationCode domain.</p></p>
     * 
     * <p><p>For Invoice (COB): AS (Adjudicated As Submitted) and 
     * ANF (Adjudicated with No Financial Impact) is not usually 
     ...
     * code from the ActAdjudicationCode domain.</p></p>
     */
    @Hl7XmlMapping({"code"})
    public Code getCode() {
