 ...
 * Information</p>
 * 
 * <p><p>The statement and justification of the Total Billed 
 ...
 * determine the possible amount owed by the payor.</p></p>
 * 
 * <p><p>There are some situations where all items for a 
 * patient need to be included in 1 Invoice Grouping, as the 
 ...
 * Group</p>
 * 
 * <p><p>Unique number generated by the pharmacy software for 
 * the specific invoice element group</p></p>
 */
...
@Hl7RootType
public class SubmittedInvoiceGroupBean extends MessagePartBean implements ca.infoway.messagebuilder.model.pcs_mr2007_v02_r02.claims.ficr_mt600201ca.InvoiceElementChoice, InvoiceElementChoice {
     ...
     * the pharmacy software for the specific invoice element 
     ...
     * Dispense, Rx Compound</p></p>
     * 
     * <p><p>of Invoice Grouping.</p><p>Each Invoice Type is used 
     * to specify 1. vocabulary, 2. structure of the Invoice 
     * Element Choice and 3. which Billable Act(s) can be included 
     * for the specified Invoice Type.</p><p>Information on 
     ...
     * Type.</p></p>
     * 
     * <p><p>RXDINV, RXCINV, CSINV, CPINV, CSPINV only for root 
     * invoice element group.</p><p>RxS1: RXDINV only for root 
     * invoice element group. DRGING for specify drug group.</p></p>
     * 
     * <p><p>RXDINV, RXCINV, CSINV, CPINV, CSPINV only for root 
     * invoice element group.</p><p>RxS1: RXDINV only for root 
     * invoice element group. DRGING for specify drug group.</p></p>
     ...
     * group. DRGING for specify drug group.</p></p>
     * 
     * <p><p>Invoice Type is the indication to the payor as to the 
     * content rules to apply when processing and adjudicating the 
     * invoice. Basically, the structure of the invoice grouping. 
     ...
     * Dispense, Rx Compound</p></p>
     * 
     * <p><p>This is used to indicate the type of Invoice 
     ...
     * be present for a Coverage Extension Request.</p></p>
     * 
     * <p><p>For Coverage Extension Results: Some adjudicators will 
     ...
     * 
     * <p><p>The period of time that the invoice pertains to. This 
     * may be a specific date or a date range (as in the month of 
     * January) for the invoice.</p></p>
     * 
     * <p><p>Transmission of this information suggests a transfer 
     * of liability for how this information/invoice is 
     ...
     * physician invoices only.</p></p>
     * 
     * <p><p>This may be useful for nursing homes. For example, 
     * they get paid so much $ per patient per month and would need 
     * to specify the time period for the invoice.</p></p>
     */
