...
/**
 * <p>InvoiceElementDetails</p>
 * 
 * <p>FICR_MT600201CA.InvoiceElementDetail: Invoice Element 
 * Details</p>
 * 
 * <p><p>Domain for InvoiceElementDetail.code is 
 * GenericBillableItemModifier</p></p>
 * 
 * <p><p>The details of the Invoice item billed for, as in the 
 * product or service.</p></p>
 * 
...
public class SubmittedInvoiceElementDetailsBean extends MessagePartBean implements ca.infoway.messagebuilder.model.pcs_mr2007_v02_r02.claims.ficr_mt600201ca.InvoiceElementChoice, InvoiceElementChoice {
     ...
     * Line item.</p></p>
     * 
     * <p><p>Only one identifier for an Invoice Detail is 
     * allowed.</p></p>
     * 
     ...
     * as the PaymentRequest.id or the InvoiceElementGroup.id.</p></p>
     * 
     * <p><p>OID (object identifier) + unique number generated by 
     * the pharmacy software for the specific invoice element 
     * detail.</p><p>The identifier will be the same as its parent 
     ...
     * <p>Submitted Invoice Line Identifier</p>
     * 
     * <p><p>Submitted Invoice Line Identifier. OID (object 
     * identifier) + unique number generated by the pharmacy 
     * software for the specific invoice element detail</p></p>
     * 
     * <p><p>Only one identifier for an Invoice Detail is 
     * allowed.</p></p>
     * 
     ...
     * Payor</p></p>
     * 
     * <p><p>RxS1: Select one of MARKUP (markup), PROFFEE 
     * (professional fee), or &lt;DIN&gt;/&lt;GTIN&gt;/&lt;UPC&gt; 
     * (drug), depending on what invoice element detail is being 
     * described.</p></p>
     * 
     * <p><p>There are specific rules, by code set, for 
     * specification of these codes (e.g. CCI codes are stripped of 
     * punctuation).</p></p>
     * 
     * <p><p>For Adjudication Results: each Invoice Element Group 
     * or Detail that has been submitted must have a corresponding 
     ...
     * are stripped of punctuation).</p></p>
     * 
     * <p><p>For Adjudication Results: each Invoice Element Group 
     * or Detail that has been submitted must have a corresponding 
     * response with the same Invoice Element code. There may be 
     ...
     * Markup, Dispense. Modifier e.g. northern isolation,off hours 
     * specialty, on call.</p></p>
     * 
     * <p><p>For Adjudication Results: each Invoice Element Group 
     * or Detail that has been submitted must have a corresponding 
     * response with the same Invoice Element code. There may be 
     ...
     * Submitted Unit Amount Price.</p></p>
     * 
     * <p><p>Attribute cannot be mandatory as it may not be present 
     ...
     * Submitted Unit Amount Price.</p></p>
     * 
     * <p><p>Derived as numerator of UnitQuantity * 
     ...
     * 
     * <p><p>A description of the number of instances of a product 
     * or service. I.e.. 4 hours, 4 mg, 4 boxes, 15 each of a 
     * container of 1000 each</p></p>
     * 
     * <p><p>Field length for value (value) may include a decimal 
     ...
     * 
     * <p><p>Field length for value (amount) includes a decimal 
     * point. Decimal point MUST be specified with 2 and only 2 
     ...
     * 
     * <p><p>Tax percentage applied to unitPriceAmt</p></p>
     * 
     * <p><p>Factor numbers are used for taxes. They represent the 
     * percentage of tax applied to unitPriceAmt.</p></p>
     * 
     * <p><p>RxS1: Not permitted, as taxes are not included in this 
     * scenario.</p></p>
     */
