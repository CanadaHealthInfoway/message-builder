 ...
 * 
 * <p><p>Unique identifier used for cross-referrence.</p></p>
 * 
 * <p><p>Identifier required to link invoices.</p></p>
 */
...
public class CrossReferenceIdentifierBean extends MessagePartBean {
     ...
     * <p>Cross Reference Identifier</p>
     * 
     * <p><p>Includes references to authorization, coverage 
     * extension and pre-determination results. Previous 
     * adjudication results are not referenced with this 
     * mechanism</p></p>
     * 
     * <p><p>Includes references to authorization, coverage 
     * extension and pre-determination results. The identifier is 
     * the Root Adjudicated Invoice Element Group ID, returned on 
     * the previous authorization, coverage extension or 
     ...
     * Invoice, would result in payment.</p></p>
     * 
     * <p><p>Includes references to authorization, coverage 
     * extension and pre-determination results. The identifier is 
     * the Root Adjudicated Invoice Element Group ID, returned on 
