 ...
 * <p>Attachments</p>
 * 
 * <p><p>Could be used to attach a Limited Use Form or a 
 * Consent Form.</p></p>
 * 
 * <p><p>If this relationship is required, it may only be 
 ...
 * inv adj response supports the needed attachments.</p></p>
 * 
 * <p><p>If this relationship is required, it may only be 
 * specified for the Root Invoice Element Group and is not 
 * permitted for all other Invoice Element Groups.</p><p>Look 
 ...
 * inv adj response supports the needed attachments.</p></p>
 * 
 * <p><p>Use of attachments must be pre-approved by the NeCST 
 * Pharmacy SIG.</p><p>RxS1: Not permitted, as attachments are 
 * not included in this scenario.</p></p>
 * 
 * <p><p>Use of attachments must be pre-approved by the NeCST 
 * Pharmacy SIG.</p><p>RxS1: Not permitted, as attachments are 
 * not included in this scenario.</p></p>
