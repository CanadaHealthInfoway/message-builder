...
@Hl7PartTypeMapping({"MCAI_MT700236CA.ControlActEvent","QUQI_MT000001CA.ControlActEvent"})
@Hl7RootType
public class ControlActEvent_2Bean extends MessagePartBean {
    ...
    private QueryContinuationBean queryContinuation;
