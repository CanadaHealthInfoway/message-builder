...
import ca.infoway.messagebuilder.model.r02_04_02.claims.merged.AdjudicatedResultsGroupBean;
import ca.infoway.messagebuilder.model.r02_04_02.claims.merged.PaymentIntentBean;
import ca.infoway.messagebuilder.model.r02_04_02.common.coct_mt680000ca.AdjudicatedInvoiceAuthorBean;
import ca.infoway.messagebuilder.model.r02_04_02.common.coct_mt680000ca.AdjudicatedInvoiceCoverageBean;
import ca.infoway.messagebuilder.model.r02_04_02.common.coct_mt680000ca.AdjudicatedInvoiceElementChoice;
import ca.infoway.messagebuilder.model.r02_04_02.common.coct_mt680000ca.InvoiceElementDetailBean;
 ...
 * 
 * <p><p>Group of Invoice Elements being referenced; ie. group 
 * of billable items.</p></p>
 */
...
public class AdjudicatedInvoiceElementGroupBean extends MessagePartBean implements AdjudicatedInvoiceElementChoice {
     ...
     * 
     * <p><p>(Completed when done, Suspended if waiting for 
     * external )(information, Active if delayed by Adjudicator or 
     * the EOB is an estimate</p></p>
     * 
     * <p>Invoice Status</p>
     * 
     * <p><p>Codes representing the defined states of an Act as 
     * defined by the Act class state machine.</p></p>
     * 
     ...
     * completed EOBs can be included in a Payment Advice).</p></p>
     * 
     * <p><p>Active EOBs are used to convey interim or preliminary 
     * adjudication results. They can also be used, with 
     * information codes, to indicate that the invoice grouping is 
