 ...
 * 
 * <p>This act "groups" all the sensitivity tests performed on 
 * a particular isolate. The battery may be made up of 
 * individual sensitivity tests using all the same testing 
 * method or using differing methods.</p>
 */
