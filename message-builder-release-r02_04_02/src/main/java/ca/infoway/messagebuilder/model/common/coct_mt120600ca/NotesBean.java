...
public class NotesBean extends MessagePartBean {
    ...
    public ca.infoway.messagebuilder.model.merged.RelatedPersonBean getAuthorAssignedPersonAsPersonalRelationship1() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.merged.RelatedPersonBean ? (ca.infoway.messagebuilder.model.merged.RelatedPersonBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsPersonalRelationship1() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.merged.RelatedPersonBean);
    }
    ...
    public ca.infoway.messagebuilder.model.common.coct_mt090508ca.HealthcareOrganizationBean getAuthorAssignedPersonAsAssignedEntity4() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.common.coct_mt090508ca.HealthcareOrganizationBean ? (ca.infoway.messagebuilder.model.common.coct_mt090508ca.HealthcareOrganizationBean) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsAssignedEntity4() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.common.coct_mt090508ca.HealthcareOrganizationBean);
    }
    ...
    public ca.infoway.messagebuilder.model.common.coct_mt911108ca.ActingPerson getAuthorAssignedPersonAsActingPerson2() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.common.coct_mt911108ca.ActingPerson ? (ca.infoway.messagebuilder.model.common.coct_mt911108ca.ActingPerson) this.authorAssignedPerson : null;
    }
    public boolean hasAuthorAssignedPersonAsActingPerson2() {
        return (this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.common.coct_mt911108ca.ActingPerson);
    }

    public ca.infoway.messagebuilder.model.merged.RelatedPersonBean getAuthorAssignedPersonAsPersonalRelationship4() {
        return this.authorAssignedPerson instanceof ca.infoway.messagebuilder.model.merged.RelatedPersonBean ? (ca.infoway.messagebuilder.model.merged.RelatedPersonBean) this.authorAssignedPerson : null;
    }
