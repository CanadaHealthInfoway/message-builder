...
public class RefusalToFillsBean extends MessagePartBean {
    ...
    private List<DetectedIssueEvent_2Bean> reasonDetectedIssueEvent = new ArrayList<DetectedIssueEvent_2Bean>();
    ...
    public List<DetectedIssueEvent_2Bean> getReasonDetectedIssueEvent() {
