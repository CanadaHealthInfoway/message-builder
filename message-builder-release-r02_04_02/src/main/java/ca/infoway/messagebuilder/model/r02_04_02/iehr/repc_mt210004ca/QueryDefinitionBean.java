...
package ca.infoway.messagebuilder.model.r02_04_02.iehr.repc_mt210004ca;
...
public class QueryDefinitionBean extends MessagePartBean {
    ...
    public List<ReferralDocumentType> getEventCategories() {
        return new RawListWrapper<CV, ReferralDocumentType>(eventCategories, CVImpl.class);
    }
    ...
    public List<ActCareProvisionRequestType> getRecordTypes() {
        return new RawListWrapper<CD, ActCareProvisionRequestType>(recordTypes, CDImpl.class);
    }
