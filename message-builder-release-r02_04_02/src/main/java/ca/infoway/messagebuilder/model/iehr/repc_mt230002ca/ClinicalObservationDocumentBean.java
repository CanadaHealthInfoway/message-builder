...
package ca.infoway.messagebuilder.model.iehr.repc_mt230002ca;
...
@Hl7RootType
public class ClinicalObservationDocumentBean extends MessagePartBean implements SHRBean {
    ...
    private DocumentContent_3Bean componentStructuredBodyComponentSectionComponentDocumentContent;
    ...
    public DocumentContent_3Bean getComponentStructuredBodyComponentSectionComponentDocumentContent() {
        return this.componentStructuredBodyComponentSectionComponentDocumentContent;
    }
    public void setComponentStructuredBodyComponentSectionComponentDocumentContent(DocumentContent_3Bean componentStructuredBodyComponentSectionComponentDocumentContent) {
    ...
    public ca.infoway.messagebuilder.model.merged.ClinicalObservationDocumentBean getComponentStructuredBodyComponentSectionComponentDocumentContentAsObservation() {
        return this.componentStructuredBodyComponentSectionComponentDocumentContent instanceof ca.infoway.messagebuilder.model.merged.ClinicalObservationDocumentBean ? (ca.infoway.messagebuilder.model.merged.ClinicalObservationDocumentBean) this.componentStructuredBodyComponentSectionComponentDocumentContent : null;
    }
    public boolean hasComponentStructuredBodyComponentSectionComponentDocumentContentAsObservation() {
        return (this.componentStructuredBodyComponentSectionComponentDocumentContent instanceof ca.infoway.messagebuilder.model.merged.ClinicalObservationDocumentBean);
    }
