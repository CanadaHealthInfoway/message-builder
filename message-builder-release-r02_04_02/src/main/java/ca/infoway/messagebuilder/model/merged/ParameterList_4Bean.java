...
@Hl7PartTypeMapping({"REPC_MT220004CA.ParameterList","REPC_MT500005CA.ParameterList"})
@Hl7RootType
public class ParameterList_4Bean extends MessagePartBean {
    ...
    public List<ActCareEventType> getRecordTypes() {
        return new RawListWrapper<CD, ActCareEventType>(recordTypes, CDImpl.class);
    }
    ...
    public List<CareSummaryDocumentType> getEventCategories() {
        return new RawListWrapper<CV, CareSummaryDocumentType>(eventCategories, CVImpl.class);
    }
