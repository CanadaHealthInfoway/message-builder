 ...
 * query</p>
 * 
 * <p>Requests retrieval of details of all adverse reactions 
 * which have been recorded against a patient's record, 
 * potentially filtered by reaction type, timerange of 
 * occurrence of reaction or timerange in which the adverse 
 * reaction info was last changed</p>
 * 
...
public class PatientAdverseReactionsQueryBean extends HL7Message_1Bean<TriggerEventBean<QueryDefinitionBean>> implements InteractionBean {
