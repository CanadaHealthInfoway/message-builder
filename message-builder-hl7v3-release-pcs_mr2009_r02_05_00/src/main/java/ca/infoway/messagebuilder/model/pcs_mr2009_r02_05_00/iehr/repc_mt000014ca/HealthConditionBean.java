...
package ca.infoway.messagebuilder.model.pcs_mr2009_r02_05_00.iehr.repc_mt000014ca;
 ...
 * 'problem list').</p>
 */
@Hl7PartTypeMapping({"REPC_MT000014CA.ConditionEvent"})
@Hl7RootType
public class HealthConditionBean extends MessagePartBean {
     ...
     * 
     * <p>Allows for unique identification of the Health Condition 
     * and is therefore mandatory. Supports drill-down queries, 
     * linking of this record to other records, matching of EHR 
     * records to locally-stored PoS records and is necessary when 
     * identifying records for amending (revising)/directional 
     * linking (superseding).</p>
     * 
     * <p>A globally unique identifier assigned by the EHR to the 
     * Health Condition record.</p><p>The identifier applies to 
     * this &quot;instance&quot; of the condition. For example, 
     * multiple pregnancies would each be treated as distinct 
     * conditions, each with a unique id.</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * condition, therefore the attribute is mandatory.</p><p>This 
     * element makes use of the CD datatype because some 
     * terminologies used for the domain require use of 
     * modifiers.</p><p>The element uses CWE to allow for the 
     * capture of Condition concepts not presently supported by the 
     ...
     * amenable to searching or categorizing.</p>
     * 
