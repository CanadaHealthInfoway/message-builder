 ...
 * 
 * <p>By requesting the action, the provider takes a level of 
 * responsibility for it. The attribute may also be used to 
 * search or filter records. Requesting providers generally 
 * have authorization to view masked information as well.</p>
 * 
 * <p>This identifies the provider who requested the 
 ...
 * looked up by retrieving the request.</p>
 * 
 * <p>REPC_MT230002CA.Author: *a: authored by</p>
 * 
 * <p>Used to identify responsibility for accuracy and 
 * relevance of the information. This association reflects 
 * primary responsibility, and is therefore 
 * mandatory.</p><p>The author is generally the person to 
 * contact with requests for additional information. In some 
 * cases, this information may also be used for filtering or 
 * sorting.</p>
 * 
 * <p>This identifies the provider who is responsible for the 
 * decision to capture the Clinical Observation Document in the 
 * patient's EHR. Note that while the author is frequently the 
 * data-enterer, this will not always be the case, for example 
 * where transcribers are involved.</p>
 * 
 ...
 * have authorization to view masked information as well.</p>
 * 
 * <p>This identifies the provider who requested the Clinical 
 * Observation Document to be performed. The request may have 
 * been verbal, electronic, as part of a referral or by other 
 * means. This element does not need to be captured in 
 * &quot;record&quot; and &quot;amend&quot; messages where a 
 * request id is captured, as the requesting provider can be 
 ...
 * patient's EHR. Note that while the author is frequently
 * ... [rest of documentation truncated due to excessive length]
 */
@Hl7PartTypeMapping({"COCT_MT130001CA.Author3","REPC_MT000007CA.Author","REPC_MT000007CA.Author3","REPC_MT000010CA.Author","REPC_MT000010CA.Author3","REPC_MT210002CA.Author","REPC_MT210003CA.Author","REPC_MT220001CA.Author","REPC_MT220001CA.Author3","REPC_MT220002CA.Author","REPC_MT220002CA.Author3","REPC_MT220003CA.Author","REPC_MT220003CA.Author3","REPC_MT230001CA.Author2","REPC_MT230002CA.Author","REPC_MT230002CA.Author2","REPC_MT230003CA.Author","REPC_MT230003CA.Author2","REPC_MT410001CA.Author","REPC_MT410003CA.Author2","REPC_MT410003CA.Author3","REPC_MT420001CA.Author2","REPC_MT420003CA.Author2","REPC_MT420003CA.Author3","REPC_MT500001CA.Author2","REPC_MT500002CA.Author2","REPC_MT500003CA.Author","REPC_MT500003CA.Author2","REPC_MT500003CA.Author3","REPC_MT500004CA.Author","REPC_MT500004CA.Author2","REPC_MT500004CA.Author3","REPC_MT610001CA.Author","REPC_MT610002CA.Author","REPC_MT610002CA.Author3"})
public class RequestedByBean extends MessagePartBean {
     ...
     * <p>Conformance/Cardinality: REQUIRED (1)</p>
     * 
     * <p>Used to allow for historical sequencing of records in the 
     * EHR, which facilitates auditing, sorting etc. This attribute 
     * is populated because it won't always be known in the 
     * circumstance where the data is being entered by a person 
     * other than the original &quot;creator&quot; of the 
     * record.</p>
     * 
     * <p>Indicates the time the decision to record when the 
     * Clinical Observation Document was made. This will usually be 
     * simultaneous with the time the record is submitted to the 
     * EHR, but in some circumstances may be before.</p>
     * 
     * <p>Un-merged Business Name: AuthoredDatetime</p>
     * 
