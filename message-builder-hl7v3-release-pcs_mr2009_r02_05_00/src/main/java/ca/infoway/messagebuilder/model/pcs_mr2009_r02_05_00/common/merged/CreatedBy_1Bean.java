 ...
 * therefore mandatory.</p>
 * 
 * <p>Choice of CMET is as follows:</p><p>1. AuthorRole if 
 * AuthorizationToken is specified and communicates 
 * author,</p><p>2. otherwise the R_ActingPerson CMET must be 
 * specified.</p>
 * 
 * <p>Indicates the person responsible for the event that 
 * caused this message.</p>
 */
@Hl7PartTypeMapping({"MCAI_MT700210CA.Author","MCAI_MT700211CA.Author","MCAI_MT700212CA.Author","MCAI_MT700220CA.Author","QUQI_MT020000CA.Author","QUQI_MT020002CA.Author"})
