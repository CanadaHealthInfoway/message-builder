 ...
 * identifiers for a provider. The receiving application will 
 * respond with the Provider Associated Identifiers Query 
 * Response containing the requested information from the 
 * provider registry system.</p>
 * 
