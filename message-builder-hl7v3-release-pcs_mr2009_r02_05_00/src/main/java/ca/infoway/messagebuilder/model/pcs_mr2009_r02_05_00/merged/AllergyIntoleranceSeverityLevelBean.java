...
import ca.infoway.messagebuilder.model.pcs_mr2009_r02_05_00.domainvalue.SeverityObservationValue;
...
public class AllergyIntoleranceSeverityLevelBean extends MessagePartBean {
     ...
     * contraindications must be managed.</p>
     * 
     ...
     * whether contraindications must be managed.</p>
     * 
     * <p>Indicates the gravity of the allergy, intolerance or 
     * reaction in terms of its actual or potential impact on the 
     * patient.</p>
     ...
     */
    @Hl7XmlMapping({"value"})
    public SeverityObservationValue getValue() {
        return (SeverityObservationValue) this.value.getValue();
    }
     ...
     * patient.</p>
     */
    public void setValue(SeverityObservationValue value) {
