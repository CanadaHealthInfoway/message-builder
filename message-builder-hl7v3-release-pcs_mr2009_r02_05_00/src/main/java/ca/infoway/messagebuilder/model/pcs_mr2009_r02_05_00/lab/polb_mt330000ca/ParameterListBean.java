...
package ca.infoway.messagebuilder.model.pcs_mr2009_r02_05_00.lab.polb_mt330000ca;
...
public class ParameterListBean extends MessagePartBean {
    ...
    private IVL<TS, Interval<Date>> observationRequestAvailabilityDateTimeRangeValue = new IVLImpl<TS, Interval<Date>>();
    ...
    /**
     * <p>Business Name: Observation Request Availability Effective 
     * Time Range</p>
     * 
     * <p>Relationship: 
     * POLB_MT330000CA.ObservationRequestAvailabilityDateTimeRange.value</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     ...
     * 
     * <p>Filters the set of records to be retrieved to those in 
     * which the observation request availability date/time for the 
     * patient is within the time boundaries specified. Either the 
     * lower bound or upper bound or both would be specified. If no 
     * value is specified, no filter will be applied.</p>
     */
    @Hl7XmlMapping({"observationRequestAvailabilityDateTimeRange/value"})
    public Interval<Date> getObservationRequestAvailabilityDateTimeRangeValue() {
        return this.observationRequestAvailabilityDateTimeRangeValue.getValue();
    }
     ...
     * value is specified, no filter will be applied.</p>
     */
    public void setObservationRequestAvailabilityDateTimeRangeValue(Interval<Date> observationRequestAvailabilityDateTimeRangeValue) {
        this.observationRequestAvailabilityDateTimeRangeValue.setValue(observationRequestAvailabilityDateTimeRangeValue);
    }
     ...
     * 
     * <p>Relationship: 
     * POLB_MT330000CA.ObservationRequestStatus.value</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     * <p>Allows for the selection of only &quot;active&quot; 
