...
public class ClinicalObservationDocumentBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: REPC_MT230001CA.Document.id</p>
     * 
     ...
     * 
     * <p>Relationship: REPC_MT230001CA.Document.statusCode</p>
     * 
     ...
     * to their health data. Awareness of the patient's desire for 
     * confidentiality is important even for providers who have 
     * access to the data because it indicates a need for extra 
     * caution before disclosing the information to other care 
     * providers.</p><p>Also allows providers to mark records as 
     ...
     * records without careful guidance.)</p><p>Two repetitions are 
     * supported to allow indicating that the record is masked from 
     * both a provider and a patient perspective.</p>
     * 
    ...
    /**
     * <p>Relationship: REPC_MT230001CA.Document.authenticator</p>
     * 
