 ...
 * required). It is used to communicate the status of a 
 * promise, typically where the filler is in the process of 
 * fulfilling an order.</p>
 * 
...
public class LaboratoryPromiseStatusBean extends HL7Message_1Bean<TriggerEvent_1Bean<PromiseChoice>> implements InteractionBean {
