...
public class MessagePartInboundArrowShape extends InboundArrowShape{
	...
	MessagePartInboundArrowShape(MessagePartLayoutItem messagePartLayoutItem, StyleProvider styleProvider) {
		super(styleProvider);
		if (messagePartLayoutItem.getInboundElement() == null){
		...
		this.inboundArrowDepth = messagePartLayoutItem.getInboundElement().getInboundArrowDepth();
