...
public class PrescriptionDispenseBean extends MessagePartBean {
     ...
     * 
     * <p> </p><p align="left">Identifier assigned by the 
     * dispensing facility.</p> <p align="left">PIN will record 
     * this as an external key against</p> <p>the event to allow 
     * for retrieval of this dispense using a given identifier.</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * 
     * <p> </p><p align="left">Communicates the intent that the 
     * dispense should</p> <p align="left">be masked if it is 
     * created.</p> <p align="left">If the dispense is</p> <p 
