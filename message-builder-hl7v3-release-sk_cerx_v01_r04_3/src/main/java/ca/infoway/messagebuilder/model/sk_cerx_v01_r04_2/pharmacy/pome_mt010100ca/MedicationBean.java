...
package ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.pharmacy.pome_mt010100ca;
...
import ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.pharmacy.merged.GroupedWithinBean;
...
public class MedicationBean extends MessagePartBean {
     ...
     * generic,</div> <div>generic formulation, or therapeutic 
     * class does the</div> <div>medication fall into. Exposes the 
     * drug hierarchy,</div> <div>allowing drill-down when 
     * prescribing and dispensing.</div> <div>Also indicates 
     * possibilities for substitution and can be</div> 
     * <div>important for detecting interactions such as 
     * allergies</div> <div>or duplicate therapy between 
     * closely-related drugs.</div> <div>&nbsp;</div>
     * 
     * <p>&nbsp;</p> <div>PIN&rsquo;s drug hierarchy only consists 
     * of Generic,</div> <div>Generic Strength, Generic 
     * Formulation, and</div> <div>Manufactured. No Drug Class 
     * information will be</div> <p>returned.&nbsp;</p>
     */
     ...
     * their</div> <div>respective quantities.</div>
     */
