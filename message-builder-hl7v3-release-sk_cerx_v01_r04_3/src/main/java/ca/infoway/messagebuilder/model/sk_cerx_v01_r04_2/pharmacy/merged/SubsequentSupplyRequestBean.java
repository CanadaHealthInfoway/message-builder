...
public class SubsequentSupplyRequestBean extends MessagePartBean {
     ...
     * research</p>
     * 
     * <p><strong>PIN will only use the Fill Quantity to determine 
     * the amount per fill. If it is not specified, PIN will not 
     * use the administration instructions and the Days Supply. 
