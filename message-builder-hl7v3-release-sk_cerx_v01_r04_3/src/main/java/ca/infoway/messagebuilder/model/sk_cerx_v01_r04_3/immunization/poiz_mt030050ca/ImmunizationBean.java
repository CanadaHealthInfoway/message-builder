 ...
 * treated as populated.</p></p>
 * 
 * <p><p>Represents a single immunization occurrence for a 
 * particular patient</p></p>
 * 
 * <p><p>Allows capturing a patient's immunization profile</p></p>
 */
...
public class ImmunizationBean extends MessagePartBean {
     ...
     * indicated.</p></p>
     * 
     * <p><p>NotImmunizedFlag</p><p>CompletionStstus (true = Not 
     * administered)</p></p>
     * 
     * <p><p>NotImmunizedFlag</p><p>CompletionStstus (true = Not 
     * administered)</p></p>
     ...
     * to as the anatomical site of vaccination.</p></p>
     * 
     * <p><p>A coded value denoting the body area where the 
     * immunization was administered.</p><p>This is also referred 
     * to as the anatomical site of vaccination.</p></p>
