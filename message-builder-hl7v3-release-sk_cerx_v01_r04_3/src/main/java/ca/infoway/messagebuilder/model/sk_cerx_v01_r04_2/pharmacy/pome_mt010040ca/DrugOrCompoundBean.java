...
public class DrugOrCompoundBean extends MessagePartBean {
     ...
     * in free text form.</p>
     * 
     * <div>As PIN will not be returning custom compounds in</div> 
     * <p>this query, this field will never be returned.&nbsp;</p>
     */
    @Hl7XmlMapping({"desc"})
     ...
     * <p>Conformance/Cardinality: REQUIRED (0-1)</p>
     * 
     * <div>Information about how the dispensed drug is or 
     * should&nbsp;asContent be contained.</div> <p>&nbsp;</p>
     */
    ...
    /**
     * <p>Business Name: Group Within</p>
     * 
     ...
     * 
     * <p>Identification of which ingredients are contained (or</p> 
     * <div>are not contained) in a drug, along with their</div> 
     * <div>respective quantities.</div>
     */
