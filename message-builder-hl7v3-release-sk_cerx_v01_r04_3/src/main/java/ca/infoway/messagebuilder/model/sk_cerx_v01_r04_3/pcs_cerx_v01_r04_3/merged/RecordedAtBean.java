 ...
 * the facility where the dispense event was performed</p></p>
 * 
 * <p><p 
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the facility/location where the patient note was 
 * recorded.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Important 
 * for performing follow-up and is therefore mandatory.</p></p>
 * 
 * <p>PORX_MT980020CA.Location: *b:dispensed at</p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the facility where the implicated dispense event was 
 * performed</p></p>
 * 
 * <p><p 
 * xmlns:html="http://www.w3.org/1999/xhtml">A_DetectedMedicationIssue</p></p>
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the pharmacy to which the prescription has been directed or 
 * which has currently assumed responsibility for dispensing 
 ...
 * prescription.</p><p 
 * xmlns:html="http://www.w3.org/1999/xhtml">This should always 
 * be known or should have an explicit null flavor of 'NA' 
 ...
 * the service delivery location where the other active 
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the clinic or facility which originally issued the 
 * prescription.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Identifies 
 * where paper records are likely located for follow-up. This 
 * is marked as 'populated' because it won't always be known 
 * for 'inferred prescriptions.</p></p>
 * 
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the service delivery location where the medical condition 
 * was recorded.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * where records are likely kept for follow-up. May also be 
 * useful in understanding the context in which the medical 
 * condition recorded.</p><p 
 * xmlns:html="http://www.w3.org/1999/xhtml">The location of 
 * entry should always exist, and is therefore mandatory.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * where records are likely kept for follow-up. May also be 
 * useful in understanding the context in which the medical 
 ...
 * where records are likely kept for follow-up. May also be 
 * useful in understanding the context in which the medical 
 * condition was recorded. The location of entry should always 
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the facility/location where the dispensing was 
 * performed.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Important 
 * for performing follow-up and therefore mandatory.</p></p>
 * 
 * <p>MCAI_MT700221CA.Location: *a1:created at</p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the facility where the event occurred.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * where paper records may be located, and may be important to 
 ...
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * the service delivery location where the allergy was 
 * recorded.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
 * where records are likely kept for follow-up. May also be 
 * useful in understanding the context in which the 
...
public class RecordedAtBean extends MessagePartBean {
     ...
     * targetted facility.</p><p 
     * xmlns:html="http://www.w3.org/1999/xhtml">'Hard' assignment 
     * (mandated facility) indicates that the prescription can be 
     * dispensed only at that facility.</p><p 
     * xmlns:html="http://www.w3.org/1999/xhtml">'Soft' assignment 
     * (usually as a patient directive) indicates that the 
     * prescription may be dispensed at facilities other than the 
     * targeted facility.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates a 
     * 'hard' or 'soft' assignment of dispensing priviledged to the 
     * targetted facility.</p><p 
     ...
     * targeted facility.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Influences 
     * whether the prescription may be transferred to a service 
     * delivery location other than the targeted dispenser.</p></p>
     * 
     * <p>Dispense Facility Not Assignable Indicator</p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
     * whether a dispenser to whom the prescription is targeted is 
     * a mandated or patient-preferred pharmacy.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Influences 
     * whether the prescription may be transferred to a service 
     * delivery location other than the targeted dispenser.</p></p>
     ...
     * time on which the dispense is expected to be picked up.</p></p>
     * 
