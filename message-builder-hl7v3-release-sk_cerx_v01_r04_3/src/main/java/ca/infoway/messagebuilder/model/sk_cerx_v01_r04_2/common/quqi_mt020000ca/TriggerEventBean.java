...
public class TriggerEventBean<PL> extends MessagePartBean {
     ...
     * <div>is a valid trigger event code but it is not the 
     * trigger</div> <p>event code associated with this 
     * interaction.&nbsp;</p>
     */
    @Hl7XmlMapping({"code"})
     ...
     * 
     * <div>Indicates the person responsible for entering the</div> 
     * <div>query into the system. This should only be 
     * specified</div> <p>if different from the author.&nbsp;</p>
     */
     ...
     * location</div> <p>where the query occurred.&nbsp;</p>
     */
