...
public class PrescriptionBean extends MessagePartBean implements MedicationRecord {
     ...
     * uniquely identified.</p>
     * 
     * <p> </p><p align="left">PIN&rsquo;s &lsquo;PIN Rx 
     * Number&rsquo; will be sent back as the Prescription Order 
     * Number.</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     * 
     * <p> </p><p align="left">Although the CeRx specification does 
     * not</p> <p align="left">specifically reference this model, 
     * the fields</p> <p align="left">listed in the specification 
     * are almost exactly</p> <p align="left">the same. See the 
