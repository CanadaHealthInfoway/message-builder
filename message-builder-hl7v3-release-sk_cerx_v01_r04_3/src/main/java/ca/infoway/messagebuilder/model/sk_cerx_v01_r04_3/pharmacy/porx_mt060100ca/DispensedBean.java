 ...
 * 
 * <p><p>Links the dispense act to the prescription order it 
 * was performed against.</p></p>
 */
@Hl7PartTypeMapping({"PORX_MT060100CA.InFulfillmentOf"})
public class DispensedBean extends MessagePartBean {

    private static final long serialVersionUID = 20120301L;
    private CombinedMedicationRequest_1Bean substanceAdministrationRequest;


    @Hl7XmlMapping({"substanceAdministrationRequest"})
    public CombinedMedicationRequest_1Bean getSubstanceAdministrationRequest() {
        return this.substanceAdministrationRequest;
    }
    public void setSubstanceAdministrationRequest(CombinedMedicationRequest_1Bean substanceAdministrationRequest) {
