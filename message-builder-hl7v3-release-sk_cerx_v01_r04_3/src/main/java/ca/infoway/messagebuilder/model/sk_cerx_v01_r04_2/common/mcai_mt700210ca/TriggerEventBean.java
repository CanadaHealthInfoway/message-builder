...
package ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.common.mcai_mt700210ca;
...
import ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.common.coct_mt470000ca.ConsentBean;
...
public class TriggerEventBean<ACT> extends MessagePartBean {
     ...
     * mandatory.</p>
     * 
     * <div>&nbsp;It will be stored</div> <div>by PIN and can be 
     ...
     * 
     * <div>A CODE_INVAL error issue will be returned if this</div> 
     * <div>does not contain the trigger event code 
     ...
     * 
     * <div>This code may be used by a specific message, eg.</div> 
     * <div>Hold Prescription, Update Allergy/Intolerance</div> 
     * <div>Each message indicates the specific subdomain</div> 
     * <div>that can be sent. For messages with no</div> 
     * <div>domain, PIN will validate that no reason is being</div> 
     * <div>sent. For messages with a specified domain, if a</div> 
     * <div>code is sent, PIN will validate that the code</div> 
     * <p>comes from the specified domain.&nbsp;</p>
     */
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     * 
     * <div>Indicates the location where the record of this 
     * event</div> <div>was entered. The may be different from the 
     * location</div> <p>where the event occurred.&nbsp;</p>
     */
     ...
     * <p>Conformance/Cardinality: POPULATED (1)</p>
     * 
     * <div>Identifies errors or warnings that are being 
     * managed</div> <p>as part of the current message.&nbsp;</p>
     */
