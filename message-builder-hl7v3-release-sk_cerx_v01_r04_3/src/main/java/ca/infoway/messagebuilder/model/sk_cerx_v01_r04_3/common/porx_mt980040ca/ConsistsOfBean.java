 ...
 * <p>b:consists of</p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Dosage 
 * instructions may be given as textual information (as in 
 * Ad-hoc Dosage Instructions specified above) or as a 
 * structured set of dosage lines. This association allows for 
 * the specification of structured dosage lines.</p></p>
 * 
 * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Structured 
 * dosage lines facilitate the checking of dosage 
 * appropriateness. It also allows for the formal calculation 
 * of days supply based on administration instructions and 
 * supplied quantity.</p></p>
 */
...
public class ConsistsOfBean extends MessagePartBean {
     ...
     * the order in which dosage lines should be performed. Ensures 
     ...
     * tabs at bedtime (sequence 1)</p></p>
     * 
     * <p><p 
     * xmlns:html="http://www.w3.org/1999/xhtml">ZDP.13.10</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Clearly 
     ...
     * intended.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Need 
