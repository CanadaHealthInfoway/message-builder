 ...
 * evidence for recording the allergy/intolerance.</p></p>
 * 
...
public class AllergyTestsBean extends MessagePartBean implements Records {
     ...
     * identifier for a specific instance of an allergy/intolerance 
     * test.</p></p>
     * 
     ...
     * value denoting the type of allergy test conducted.</p></p>
     * 
     ...
     * type to support SNOMED post-coordination.</p></p>
     */
    @Hl7XmlMapping({"code"})
     ...
     * which the allergy test was performed.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Allows 
     * providers to evaluate the currency of the test.</p></p>
     */
     ...
     * indicating result of the allergy test.</p></p>
     * 
     ...
     * 'code' attribute using SNOMED.</p></p>
     * 
