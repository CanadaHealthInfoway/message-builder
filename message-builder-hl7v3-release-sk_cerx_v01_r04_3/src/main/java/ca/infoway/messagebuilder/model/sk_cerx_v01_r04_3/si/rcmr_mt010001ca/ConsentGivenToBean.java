...
public class ConsentGivenToBean extends MessagePartBean {
     ...
     * has been constrained to only allow the Assigned 
     * Person.</strong></p></p>
     * 
     * <p><p>If a provider is specified here, then the consent is 
     * only being given to that provider. If a facility is 
     * specified, then the consent is being given to all providers 
