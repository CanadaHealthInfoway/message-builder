 ...
 * discrete control over different types of information.</p></p>
 */
...
public class AccessTypeBean extends MessagePartBean {
     ...
     * consents (or even keywords) may be needed to access 
     * different types of patient information (e.g. demographics, 
