...
public class AcknowledgementBean extends MessagePartBean {
     ...
     * successful and is therefore mandatory.</p>
     * 
     * <p><div>This will be &lsquo;AA&rsquo; unless there are 
     * detected</div> <div>transport-level errors in which case it 
     * will be &lsquo;AE&rsquo;.</div> <p>&lsquo;AR&rsquo; will 
     * never be sent.&nbsp;</p></p>
     */
     ...
     * <p>Conformance/Cardinality: OPTIONAL (0-1)</p>
     * 
     * <p> <p>This will indicate the number of messages that 
     * are</p> <p>waiting for the specified system to retrieve.</p> 
     * </p>
     * 
     * <p>Indicates to a system how many polled messages are 
     * available without the need so send a separate query. The 
     ...
     * <p>Conformance/Cardinality: REQUIRED (0-50)</p>
     * 
     * <p><div>Any errors, warnings, or information messages will 
     * be</div> <p>go here.&nbsp;</p></p>
     */
