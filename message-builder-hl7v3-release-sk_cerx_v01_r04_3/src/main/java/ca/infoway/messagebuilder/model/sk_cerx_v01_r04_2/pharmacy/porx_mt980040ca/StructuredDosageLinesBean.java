...
public class StructuredDosageLinesBean extends MessagePartBean {
     ...
     * Timing).</p>
     * 
     * <p><div>If this is specified, then Dosage Range must</div> 
     * <div>not be specified or a BUS error issue will be</div> 
     * <p>returned.&nbsp;</p></p>
     */
    @Hl7XmlMapping({"text"})
     ...
     * 
     * <p><div>If this is specified, then Dosing</div> 
     * <div>Timing/Frequency must be specified or a</div> 
     * <div>MISSCOND error issue will be returned.</div> <div>If 
     * this is specified, then Ad-Hoc Dosage</div> <div>Instruction 
     * must not be specified or a BUS</div> <p>error issue will be 
     * returned.&nbsp;</p></p>
     */
