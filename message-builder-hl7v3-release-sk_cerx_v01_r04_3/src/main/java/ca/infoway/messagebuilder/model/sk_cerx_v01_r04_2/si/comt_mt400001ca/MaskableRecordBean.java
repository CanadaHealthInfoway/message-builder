...
public class MaskableRecordBean extends MessagePartBean {
     ...
     * face="Helvetica"><font color="#000080" size="2" 
     * face="Helvetica"> <p align="left">The identifier of the 
     * prescription, dispense, nonprescribed drug or allergy for 
     * which the masking status is being changed.</p> 
     * </font></font></font> <p align="left">Although CeRx defines 
     * this as 0..1, PIN only supports the masking of a specific 
     * record so<br /> requires this to be sent. If this identifier 
     * is not for a prescription,dispense, non-prescribed drug or 
     * allergy, then a BUS error issue will be returned</p> 
     * </font></font></font></b></p>
     */
    @Hl7XmlMapping({"id"})
