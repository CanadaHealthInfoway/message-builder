...
public class MaskableRecordBean extends MessagePartBean {
     ...
     * as well.</p>
     * 
     * <p> </p><p align="left">The identifier of the prescription, 
     * dispense, nonprescribed drug or allergy for which the 
     * masking status is being changed.</p> <p 
     * align="left">Although CeRx defines this as 0..1, PIN only 
     * supports the masking of a specific record so requires this 
     * to be sent. If this identifier is not for a 
