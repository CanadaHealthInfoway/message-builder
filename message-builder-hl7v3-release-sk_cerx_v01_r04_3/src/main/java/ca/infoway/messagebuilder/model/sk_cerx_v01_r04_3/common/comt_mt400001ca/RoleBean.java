...
public class RoleBean extends MessagePartBean {
     ...
     * the materia (e.g drug) whose associated records should be 
     * masked.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Allows 
     * masking a drug, avoiding the requirement to mask each 
     * prescription and dispense individually.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Usually 
     * specified at the generic or therapeutic-equivalent level to 
     * ensure related medications are also covered.</p></p>
     */
