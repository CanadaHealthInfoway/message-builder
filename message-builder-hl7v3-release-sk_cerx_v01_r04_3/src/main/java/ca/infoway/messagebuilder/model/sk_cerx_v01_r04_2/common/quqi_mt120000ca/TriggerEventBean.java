...
public class TriggerEventBean<ACT,PL> extends MessagePartBean {
     ...
     * 
     * <div>PIN will echo the ID sent in the Update Trigger</div> 
     * <p>Event.&nbsp;</p>
     */
    @Hl7XmlMapping({"id"})
     ...
     * processed.</p>
     * 
     * <div>As all queries are executed when the message is</div> 
     * <p>received, this will not be populated by PIN.&nbsp;</p>
     */
     ...
     * 
     * <div>This will contain the reason code contained in</div> 
