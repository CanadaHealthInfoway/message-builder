...
package ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.common.coct_mt050202ca;
 ...
 * PIN, all details that are known by the jurisdiction&rsquo;s 
 * </p><p>COCT_MT050202CA is currently only used in the Add 
 * Record Note and the Record Consent transactions.</p> <p 
 ...
 * messages to PIN.</p> <p align="left">In that case, the 
 * business rules specified below might be relaxed since PIN 
 * will not be expected to validate the patient details.</p>
 */
...
public class PatientBean extends MessagePartBean {
     ...
     * person by a Federal,</p> <p> </p><p align="left">Provincial, 
     * and Territorial jurisdiction.</p> <p>&nbsp;</p> <p 
     * align="left">The specific</p> <p align="left">set of 
     * identifiers that can be sent to PIN will be</p> <p 
     * align="left">determined by a jurisdiction. When sent by 
     * PIN,</p> <p align="left">this will be the 
