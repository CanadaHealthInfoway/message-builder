...
package ca.infoway.messagebuilder.model.sk_cerx_v01_r04_2.common.mcai_mt700220ca;
...
public class TriggerEventBean<ACT> extends MessagePartBean {
     ...
     * 
     * <div>This will contain the Trigger Event code 
     * associated</div> <p>with the response.&nbsp;</p>
     */
    @Hl7XmlMapping({"code"})
     ...
     * 
     * <div>No code will be returned as accept responses</div> 
     * <div>do not have a domain and the domain specified</div> 
     * <p>by Infoway for reject responses does not exist.&nbsp;</p>
     */
     ...
     * </p><p>Acknowledgement responses tend to have payloads</p> 
     * <p>while Rejection responses do not.</p>
     */
