...
public class AcknowledgementBean extends MessagePartBean {
     ...
     * whether the previous interaction was successfully 
     * processed.</p></p>
     * 
     ...
     * number of messages waiting to be retrieved.</p></p>
     * 
     ...
     * because not all systems will support polling.</p></p>
     */
     ...
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">Indicates 
     * the priority of the highest-priority message that is waiting 
     * on the poll queue for the system being responded to.</p></p>
     * 
     * <p><p xmlns:html="http://www.w3.org/1999/xhtml">The priority 
     * of the waiting message may influence how quickly the polling 
     ...
     * the identifier of the message this current message is 
     * acknowledging.</p></p>
     * 
     ...
     * This attribute is therefore mandatory.</p></p>
     */
