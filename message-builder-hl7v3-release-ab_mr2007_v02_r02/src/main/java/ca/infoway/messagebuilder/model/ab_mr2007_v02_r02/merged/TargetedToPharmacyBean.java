 ...
 * should always be known, and is therefore mandatory.</p>
 * 
 * <p>COMT_MT900001AB.Location: *a:Logon Facility</p>
 * 
 * <p>This attribute must match the CREATED AT (SERVICE 
 * LOCATION) identified in the Trigger Event Wrapper for Acts 
 * from Clinical.</p>
 * 
 * <p>Indicates the facility being logged on to. If not 
 * specified, only default permissions will be granted. (A list 
 * of potential logon facilities will be provided in the 
 * response.)</p>
 * 
 * <p>Logon permissions are often granted only in the context 
 * of access through a particular facility.</p>
 * 
...
public class TargetedToPharmacyBean extends MessagePartBean {
     ...
     * 
     * <p>Relationship: 
     * COMT_MT900001AB.Location.serviceDeliveryLocation</p>
     * 
     * <p>Conformance/Cardinality: MANDATORY (1)</p>
     * 
     * <p>Un-merged Business Name: (no business name specified)</p>
