...
import ca.infoway.messagebuilder.model.ab_mr2007_v02_r02.domainvalue.SystemTransactionCode;
...
public class TransactionPermissionBean extends MessagePartBean {
    ...
    private List<AssignedPersonBean> responsiblePartyAssignedEntity = new ArrayList<AssignedPersonBean>();
     ...
     * 
     * <p>Indicates to the system with which the user has logged on 
     * what the user can actually do.</p>
     */
    @Hl7XmlMapping({"code"})
    public SystemTransactionCode getCode() {
        return (SystemTransactionCode) this.code.getValue();
    }
     ...
     * what the user can actually do.</p>
     */
    public void setCode(SystemTransactionCode code) {
    ...
    public List<AssignedPersonBean> getResponsiblePartyAssignedEntity() {
