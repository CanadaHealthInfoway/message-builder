...
import ca.infoway.messagebuilder.model.ab_mr2007_v02_r02.cr.merged.ConfidenceValueBean;
...
public class IdentifiedPersonBean extends MessagePartBean {
    ...
    private List<BL> identifiedPersonMultipleBirthInd = new ArrayList<BL>();
    private List<INT> identifiedPersonMultipleBirthOrderNumber = new ArrayList<INT>();
    ...
    public List<Boolean> getIdentifiedPersonMultipleBirthInd() {
        return new RawListWrapper<BL, Boolean>(identifiedPersonMultipleBirthInd, BLImpl.class);
    }
    ...
    public List<Integer> getIdentifiedPersonMultipleBirthOrderNumber() {
        return new RawListWrapper<INT, Integer>(identifiedPersonMultipleBirthOrderNumber, INTImpl.class);
    }
