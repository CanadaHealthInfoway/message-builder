...
package ca.infoway.messagebuilder.model.ab_mr2007_v02_r02.ab_mr2007_v02_r02.merged;
...
public class ActPermissionRequestBean extends MessagePartBean {
     ...
     * 
     * <p><p>This must be the &quot;receiving application&quot; 
     * from the transmission wrapper</p></p>
     * 
     * <p><p>Indicates the application to which the user is logging 
     * on.</p></p>
     * 
     * <p><p>This is mandatory, as logons must be associated with a 
     ...
     * a physical system.</p></p>
     * 
     * <p>A:Logon Application</p>
     * 
     * <p><p>Indicates the application to which the password change 
     * applies</p></p>
     * 
     * <p><p>This is mandatory, as passwords must be associated 
     * with a particular application. Note that the application 
     * might be a &quot;logical&quot; construct providing access to 
     * numerous physical systems, or might only provide access to a 
     * part of a physical system.</p></p>
     */
     ...
     * <p>C:Password</p>
     * 
     * <p><p>This is the current password associated with the user 
     * id used to authenticate the user to the application.</p></p>
     * 
     * <p><p>This element is mandatory because validating identity 
     * is the key function of the logon transaction.</p></p>
     */
     ...
     * <p>B:Logon User</p>
     * 
     * <p><p>Indicates the userid of the person being logged 
     * on.</p></p>
     * 
     * <p><p>This is mandatory because you can't log someone on if 
     * you don't know who they are . . .</p></p>
     */
     ...
     * <p>C: Old Password</p>
     * 
     * <p><p>This is the original password associated with the user 
     * id previously used to authenticate the user to the 
     * application.</p></p>
     * 
     * <p><p>This element is mandatory to validate that the 
     * password is being changed by the original user.</p></p>
     */
     ...
     * <p>New password</p>
     * 
     * <p><p>Indicates the value the password should be changed 
     * to</p></p>
     * 
     * <p><p>Mandatory because a null password is not allowed</p></p>
     */
