...
public class MimeTypes {
	...
	/**
	 * <p>The MIME type for PNG images.
	 */
	public static final String IMAGE_PNG = "image/png";
	/**
	 * <p>The MIME type for HTML documents.
	 */
	public static final String HTML = "text/html";
	/**
	 * <p>The MIME type for XML documents.
	 */
	public static final String XML = "text/xml";
	/**
	 * <p>The MIME type for JSON documents.
	 */
	public static final String JSON = "application/json";
	/**
	 * <p>The MIME type for VCard attachments.
	 */
	public static final String VCARD = "text/directory;profile=vCard";
	/**
	 * <p>The MIME type for plain text.
	 */
	public static final String PLAIN_TEXT = "text/plain";
	/**
	 * <p>The MIME type for PDF documents.
	 */
	...
	/**
	 * <p>The MIME type for Microsoft Word documents.
	 */
	public static final String MICROSOFT_WORD = "application/msword";
	/**
	 * <p>The MIME type for Microsoft Excel spreadsheets.
	 */
