...
public class DrugProductBean extends MessagePartBean implements MedicationBean {
    ...
    private DrugPackageBean administerableMedicineAsContentContainerPackagedMedicine;
    private CV<OrderableDrugForm> administerableMedicineAsContentContainedManufacturedMaterialKindFormCode = new CVImpl<OrderableDrugForm>();
    ...
    @Hl7XmlMapping({"administerableMedicine/asContent/quantity"})
    ...
    @Hl7XmlMapping({"administerableMedicine/asContent/containerPackagedMedicine"})
    public DrugPackageBean getAdministerableMedicineAsContentContainerPackagedMedicine() {
        return this.administerableMedicineAsContentContainerPackagedMedicine;
    }
    public void setAdministerableMedicineAsContentContainerPackagedMedicine(DrugPackageBean administerableMedicineAsContentContainerPackagedMedicine) {
        this.administerableMedicineAsContentContainerPackagedMedicine = administerableMedicineAsContentContainerPackagedMedicine;
    }

    @Hl7XmlMapping({"administerableMedicine/asContent/containedManufacturedMaterialKind/formCode"})
    public OrderableDrugForm getAdministerableMedicineAsContentContainedManufacturedMaterialKindFormCode() {
        return this.administerableMedicineAsContentContainedManufacturedMaterialKindFormCode.getValue();
    }
    public void setAdministerableMedicineAsContentContainedManufacturedMaterialKindFormCode(OrderableDrugForm administerableMedicineAsContentContainedManufacturedMaterialKindFormCode) {
        this.administerableMedicineAsContentContainedManufacturedMaterialKindFormCode.setValue(administerableMedicineAsContentContainedManufacturedMaterialKindFormCode);
    }
