 ...
 */
public class XmlNodeDeleteFilter extends XmlIndependentFilterBase {
	private NamespaceContext nsContext;
	private String xpathExpr;
	private XPath xpath;
	
	public XmlNodeDeleteFilter(NamespaceContext nsContext, String[] args) {
		if (args.length != 1)
	...
	public XmlNodeDeleteFilter(NamespaceContext nsContext, String xpathExpr) {
