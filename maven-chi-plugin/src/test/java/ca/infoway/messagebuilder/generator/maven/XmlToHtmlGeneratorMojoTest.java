...
public class XmlToHtmlGeneratorMojoTest {

	@Mock
	HtmlGeneratorFactory factory;
	@Mock
	...
	public void shouldRecognizeMissingParameters() throws Exception {
		XmlToHtmlGeneratorMojo mojo = new XmlToHtmlGeneratorMojo(this.factory);
		mojo.execute();
	}
	...
	public void shouldRecognizeMissingMessageSetParameter() throws Exception {
		XmlToHtmlGeneratorMojo mojo = new XmlToHtmlGeneratorMojo(this.factory);
		mojo.htmlFolder = new File(SystemUtils.JAVA_IO_TMPDIR);
		mojo.execute();
	}
