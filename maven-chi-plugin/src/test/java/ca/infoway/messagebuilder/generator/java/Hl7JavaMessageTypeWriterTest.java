...
public class Hl7JavaMessageTypeWriterTest {
	...
	public void setUp() throws Exception {
		...
		this.importDeclarationGenerator = this.jmock.mock(ImportDeclarationGenerator.class);
	...
	public void shouldWriteAutoGenerationComment() throws Exception {
		...
		Hl7JavaMessageTypeWriter typeWriter = new Hl7JavaMessageTypeWriter(type, this.translator, null);
