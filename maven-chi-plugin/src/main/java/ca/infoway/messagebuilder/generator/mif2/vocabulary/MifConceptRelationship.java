...
public class MifConceptRelationship {

	@Attribute(required=false)
	private String relationshipName;
	
	@Element(required=false)
	private MifTargetConcept targetConcept;
	...
	public MifTargetConcept getTargetConcept() {
		return targetConcept;
	}

	public void setTargetConcept(MifTargetConcept targetConcept) {
