...
public class MifToXmlGenerator implements MessageSetGenerator {
	...
	public MifToXmlGenerator(OutputUI outputUI, String version, String realmCode, String descriptiveName, File mifTransform, File reportDir) throws GeneratorException {
		this.outputUI = outputUI;
		this.reportDir = reportDir;
		this.mifRegistry = new MifRegistry(mifTransform, outputUI);
		
		this.messageSet.setVersion(version);
		this.messageSet.setRealmCode(StringUtils.isBlank(realmCode) ? "CA" : realmCode);
		this.messageSet.setDescriptiveName(StringUtils.isBlank(descriptiveName) ? "Message set generated by Message Builder: " + new Date() : descriptiveName);
