...
public class MifSupplementArtifact {

	@Element(required=false)
	private MifSupplementedObject supplementedObject;
	
	@Element(required=false)
	private MifAnnotations annotations;
	
	public MifSupplementedObject getSupplementedObject() {
		return supplementedObject;
	}

	public void setSupplementedObject(MifSupplementedObject supplementedObject) {
		this.supplementedObject = supplementedObject;
	}
