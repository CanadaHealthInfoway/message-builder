...
public class MifCodeSystemHeader {

	@Attribute(required=false)
	private String primaryRepository;
	@Element(required=false)
	private MifCodeSystemResponsibleGroup responsibleGroup;
	...
	public MifCodeSystemResponsibleGroup getResponsibleGroup() {
		return responsibleGroup;
	}
	public void setResponsibleGroup(MifCodeSystemResponsibleGroup responsibleGroup) {
