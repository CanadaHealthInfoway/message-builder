...
package ca.infoway.messagebuilder.model.common.qucr_mt820201ca;
 ...
 * payor) or date, payee, payor needs to be specified. 
 * 
 * <p>At least one parameter item must be specified. 
 */
...
public class ParameterListBean extends MessagePartBean {
    ...
    private CV<Code> invoiceElementGroupCodeValue = new CVImpl<Code>();
    ...
    public Code getInvoiceElementGroupCodeValue() {
        return this.invoiceElementGroupCodeValue.getValue();
    }
