...
@Hl7PartTypeMapping({"REPC_MT000001CA.Subject6","REPC_MT000005CA.Subject6","REPC_MT000009CA.Subject6","REPC_MT000013CA.Subject6"})
public class Subject6_1Bean extends MessagePartBean {
    ...
    private StartsAfterStartOf_2Bean observationEventStartsAfterStartOf = new StartsAfterStartOf_2Bean();
    private Subject6_1Bean observationEventSubject = new Subject6_1Bean();
    ...
    @Hl7XmlMapping({"observationEvent/startsAfterStartOf"})
    public StartsAfterStartOf_2Bean getObservationEventStartsAfterStartOf() {
        return this.observationEventStartsAfterStartOf;
    }
    public void setObservationEventStartsAfterStartOf(StartsAfterStartOf_2Bean observationEventStartsAfterStartOf) {
        this.observationEventStartsAfterStartOf = observationEventStartsAfterStartOf;
    }

    @Hl7XmlMapping({"observationEvent/subject"})
    public Subject6_1Bean getObservationEventSubject() {
        return this.observationEventSubject;
    }
    public void setObservationEventSubject(Subject6_1Bean observationEventSubject) {
        this.observationEventSubject = observationEventSubject;
    }
    ...
    @Hl7XmlMapping({"observationEvent/negationInd"})
    ...
    @Hl7XmlMapping({"observationEvent/subjectOf/severityObservation/value"})
