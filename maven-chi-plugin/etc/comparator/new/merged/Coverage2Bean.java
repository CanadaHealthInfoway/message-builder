...
public class Coverage2Bean extends MessagePartBean {
    ...
    private ResponsibleOrganizationBean coverageAuthorCarrierRoleUnderwritingOrganization = new ResponsibleOrganizationBean();
    ...
    @Hl7XmlMapping({"coverage/author/carrierRole/underwritingOrganization"})
    public ResponsibleOrganizationBean getCoverageAuthorCarrierRoleUnderwritingOrganization() {
        return this.coverageAuthorCarrierRoleUnderwritingOrganization;
    }
    public void setCoverageAuthorCarrierRoleUnderwritingOrganization(ResponsibleOrganizationBean coverageAuthorCarrierRoleUnderwritingOrganization) {
        this.coverageAuthorCarrierRoleUnderwritingOrganization = coverageAuthorCarrierRoleUnderwritingOrganization;
    }
